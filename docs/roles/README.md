...
| [`blackbox_exporter_setup`](./blackbox_exporter_setup.md) | Install and configure Prometheus Blackbox Exporter for probing web services. |
...
| [`ecube_setup`](./ecube_setup.md) | Installs ECUBE from GitHub Releases using the upstream Linux installer. |
...
| [`gh_cli_setup`](./gh_cli_setup.md) | Install GitHub CLI (gh) on Debian/Ubuntu |
...
| [`ipsec_vpn_server_setup`](./ipsec_vpn_server_setup.md) | Installs and configures the hwdsl2 IPsec VPN server Docker container, including vpn.env and docker-compose configuration. |
...
| [`jsvc_setup`](./jsvc_setup.md) | Builds and installs Apache Commons Daemon JSVC from source. |
...
| [`pve_exporter_setup`](./pve_exporter_setup.md) | Install and configure prometheus-pve-exporter for Proxmox VE monitoring. |
...
| [`semaphoreui_setup`](./semaphoreui_setup.md) | Installs and configures [Semaphore UI](https://docs.semaphoreui.com/) with optional Entra ID OIDC integration. |
