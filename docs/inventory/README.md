...
| `rproxy-0` | [`ad`](ad.md), [`ombi`](ombi.md), [`synology`](synology.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`services`](services.md), [`pve`](pve.md), [`ansible`](ansible.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](ad.md), [`ombi`](ombi.md), [`synology`](synology.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`services`](services.md), [`pve`](pve.md), [`ansible`](ansible.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](ad.md), [`ombi`](ombi.md), [`synology`](synology.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`services`](services.md), [`pve`](pve.md), [`ansible`](ansible.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md) | linux, python, rproxy_secondary, vms |
