...
| `rproxy-0` | [`semaphore`](semaphore.md), [`synology`](synology.md), [`ansible`](ansible.md), [`services`](services.md), [`truenas`](truenas.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`semaphore`](semaphore.md), [`synology`](synology.md), [`ansible`](ansible.md), [`services`](services.md), [`truenas`](truenas.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`semaphore`](semaphore.md), [`synology`](synology.md), [`ansible`](ansible.md), [`services`](services.md), [`truenas`](truenas.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
