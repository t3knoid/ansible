...
| `prometheus-0` | [`redmine`](redmine.md), [`plex`](plex.md), [`dns`](dns.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`minecraft`](minecraft.md), [`pg`](pg.md), [`grafana`](grafana.md), [`services`](services.md), [`vpn`](vpn.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`redmine`](redmine.md), [`pve`](pve.md), [`ecube`](ecube.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`ansible`](ansible.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`services`](services.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`prometheus`](prometheus.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](redmine.md), [`pve`](pve.md), [`ecube`](ecube.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`ansible`](ansible.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`services`](services.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`prometheus`](prometheus.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](redmine.md), [`pve`](pve.md), [`ecube`](ecube.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`ansible`](ansible.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`services`](services.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`prometheus`](prometheus.md) | linux, node_exporter, python, rproxy_secondary, vms |
