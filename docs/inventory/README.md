...
| `prometheus-0` | [`vpn`](vpn.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`dns`](dns.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`pg`](pg.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`services`](services.md), [`minecraft`](minecraft.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`ad`](ad.md), [`plex`](plex.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`services`](services.md), [`synology`](synology.md), [`jenkins`](jenkins.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`ad`](ad.md), [`plex`](plex.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`services`](services.md), [`synology`](synology.md), [`jenkins`](jenkins.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`ad`](ad.md), [`plex`](plex.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`services`](services.md), [`synology`](synology.md), [`jenkins`](jenkins.md) | linux, node_exporter, python, rproxy_secondary, vms |
