...
| `rproxy-0` | [`jenkins`](jenkins.md), [`pve`](pve.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`redmine`](redmine.md), [`plex`](plex.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`services`](services.md), [`ansible`](ansible.md), [`ad`](ad.md), [`rproxy`](rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`jenkins`](jenkins.md), [`pve`](pve.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`redmine`](redmine.md), [`plex`](plex.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`services`](services.md), [`ansible`](ansible.md), [`ad`](ad.md), [`rproxy`](rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`jenkins`](jenkins.md), [`pve`](pve.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`redmine`](redmine.md), [`plex`](plex.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`services`](services.md), [`ansible`](ansible.md), [`ad`](ad.md), [`rproxy`](rproxy.md) | linux, python, rproxy_secondary, vms |
