...
| `rproxy-0` | [`pve`](pve.md), [`synology`](synology.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`ad`](ad.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`services`](services.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`pve`](pve.md), [`synology`](synology.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`ad`](ad.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`services`](services.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`pve`](pve.md), [`synology`](synology.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`ad`](ad.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`services`](services.md) | linux, python, rproxy_secondary, vms |
