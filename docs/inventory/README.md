...
| `rproxy-0` | [`pve`](pve.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`services`](services.md), [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`ad`](ad.md), [`ombi`](ombi.md), [`plex`](plex.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`pve`](pve.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`services`](services.md), [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`ad`](ad.md), [`ombi`](ombi.md), [`plex`](plex.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`pve`](pve.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`services`](services.md), [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`ad`](ad.md), [`ombi`](ombi.md), [`plex`](plex.md) | linux, python, rproxy_secondary, vms |
