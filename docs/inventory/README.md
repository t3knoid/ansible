...
| `rproxy-0` | [`ansible`](ansible.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`synology`](synology.md), [`ombi`](ombi.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`services`](services.md), [`plex`](plex.md), [`prometheus`](prometheus.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](ansible.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`synology`](synology.md), [`ombi`](ombi.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`services`](services.md), [`plex`](plex.md), [`prometheus`](prometheus.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](ansible.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`synology`](synology.md), [`ombi`](ombi.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`services`](services.md), [`plex`](plex.md), [`prometheus`](prometheus.md) | linux, python, rproxy_secondary, vms |
