...
| `rproxy-0` | [`grafana`](grafana.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`plex`](plex.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pve`](pve.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](grafana.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`plex`](plex.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pve`](pve.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](grafana.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`plex`](plex.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pve`](pve.md) | linux, python, rproxy_secondary, vms |
