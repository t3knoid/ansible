...
| `rproxy-0` | [`semaphore`](semaphore.md), [`services`](services.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`truenas`](truenas.md), [`plex`](plex.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`semaphore`](semaphore.md), [`services`](services.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`truenas`](truenas.md), [`plex`](plex.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`semaphore`](semaphore.md), [`services`](services.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`truenas`](truenas.md), [`plex`](plex.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
