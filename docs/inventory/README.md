...
| `rproxy-0` | [`services`](services.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`pve`](pve.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`redmine`](redmine.md), [`ad`](ad.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`pve`](pve.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`redmine`](redmine.md), [`ad`](ad.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`pve`](pve.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`redmine`](redmine.md), [`ad`](ad.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md) | linux, python, rproxy_secondary, vms |
