...
| `rproxy-0` | [`ansible`](ansible.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`plex`](plex.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`pve`](pve.md), [`ad`](ad.md), [`redmine`](redmine.md), [`services`](services.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](ansible.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`plex`](plex.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`pve`](pve.md), [`ad`](ad.md), [`redmine`](redmine.md), [`services`](services.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](ansible.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`plex`](plex.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`pve`](pve.md), [`ad`](ad.md), [`redmine`](redmine.md), [`services`](services.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md) | linux, python, rproxy_secondary, vms |
