...
| `rproxy-0` | [`prometheus`](prometheus.md), [`pve`](pve.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`plex`](plex.md), [`ansible`](ansible.md), [`synology`](synology.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`services`](services.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`prometheus`](prometheus.md), [`pve`](pve.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`plex`](plex.md), [`ansible`](ansible.md), [`synology`](synology.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`services`](services.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`prometheus`](prometheus.md), [`pve`](pve.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`plex`](plex.md), [`ansible`](ansible.md), [`synology`](synology.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`services`](services.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
