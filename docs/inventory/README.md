...
| `prometheus-0` | [`plex`](plex.md), [`minecraft`](minecraft.md), [`prometheus`](prometheus.md), [`dns`](dns.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`services`](services.md), [`pg`](pg.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`vpn`](vpn.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`plex`](plex.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`services`](services.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`ecube`](ecube.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`plex`](plex.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`services`](services.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`ecube`](ecube.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`plex`](plex.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`services`](services.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`ecube`](ecube.md) | linux, node_exporter, python, rproxy_secondary, vms |
