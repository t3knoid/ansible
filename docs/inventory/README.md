...
| `rproxy-0` | [`services`](services.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`plex`](plex.md), [`ansible`](ansible.md), [`ad`](ad.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`synology`](synology.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`semaphore`](semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`plex`](plex.md), [`ansible`](ansible.md), [`ad`](ad.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`synology`](synology.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`semaphore`](semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`plex`](plex.md), [`ansible`](ansible.md), [`ad`](ad.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`synology`](synology.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`semaphore`](semaphore.md) | linux, python, rproxy_secondary, vms |
