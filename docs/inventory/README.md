...
| `rproxy-0` | [`synology`](synology.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`ansible`](ansible.md), [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`services`](services.md), [`pve`](pve.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`synology`](synology.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`ansible`](ansible.md), [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`services`](services.md), [`pve`](pve.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`synology`](synology.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`ansible`](ansible.md), [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`services`](services.md), [`pve`](pve.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md) | linux, python, rproxy_secondary, vms |
