...
| `rproxy-0` | [`pve`](pve.md), [`redmine`](redmine.md), [`plex`](plex.md), [`ansible`](ansible.md), [`services`](services.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`synology`](synology.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`pve`](pve.md), [`redmine`](redmine.md), [`plex`](plex.md), [`ansible`](ansible.md), [`services`](services.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`synology`](synology.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`pve`](pve.md), [`redmine`](redmine.md), [`plex`](plex.md), [`ansible`](ansible.md), [`services`](services.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`synology`](synology.md) | linux, python, rproxy_secondary, vms |
