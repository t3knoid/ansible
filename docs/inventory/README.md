...
| `rproxy-0` | [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`synology`](synology.md), [`services`](services.md), [`plex`](plex.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`synology`](synology.md), [`services`](services.md), [`plex`](plex.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`synology`](synology.md), [`services`](services.md), [`plex`](plex.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md) | linux, python, rproxy_secondary, vms |
