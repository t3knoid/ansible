...
| `rproxy-0` | [`pve`](pve.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`ecube`](ecube.md), [`services`](services.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`redmine`](redmine.md), [`plex`](plex.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`synology`](synology.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`pve`](pve.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`ecube`](ecube.md), [`services`](services.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`redmine`](redmine.md), [`plex`](plex.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`synology`](synology.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`pve`](pve.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`ecube`](ecube.md), [`services`](services.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`redmine`](redmine.md), [`plex`](plex.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`synology`](synology.md) | linux, python, rproxy_secondary, vms |
