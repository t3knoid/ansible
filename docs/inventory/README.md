...
| `rproxy-0` | [`truenas`](truenas.md), [`ansible`](ansible.md), [`services`](services.md), [`pve`](pve.md), [`ombi`](ombi.md), [`redmine`](redmine.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ad`](ad.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`synology`](synology.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`truenas`](truenas.md), [`ansible`](ansible.md), [`services`](services.md), [`pve`](pve.md), [`ombi`](ombi.md), [`redmine`](redmine.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ad`](ad.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`synology`](synology.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`truenas`](truenas.md), [`ansible`](ansible.md), [`services`](services.md), [`pve`](pve.md), [`ombi`](ombi.md), [`redmine`](redmine.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ad`](ad.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`synology`](synology.md) | linux, python, rproxy_secondary, vms |
