...
| `rproxy-0` | [`services`](services.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ad`](ad.md), [`pve`](pve.md), [`truenas`](truenas.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`synology`](synology.md), [`ecube`](ecube.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ad`](ad.md), [`pve`](pve.md), [`truenas`](truenas.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`synology`](synology.md), [`ecube`](ecube.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ad`](ad.md), [`pve`](pve.md), [`truenas`](truenas.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`synology`](synology.md), [`ecube`](ecube.md) | linux, python, rproxy_secondary, vms |
