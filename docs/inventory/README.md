...
| `prometheus-0` | [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`vpn`](vpn.md), [`minecraft`](minecraft.md), [`plex`](plex.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pg`](pg.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`redmine`](redmine.md), [`pve`](pve.md), [`ecube`](ecube.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`synology`](synology.md), [`services`](services.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`redmine`](redmine.md), [`pve`](pve.md), [`ecube`](ecube.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`synology`](synology.md), [`services`](services.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`redmine`](redmine.md), [`pve`](pve.md), [`ecube`](ecube.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`synology`](synology.md), [`services`](services.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md) | linux, node_exporter, python, rproxy_secondary, vms |
