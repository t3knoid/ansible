...
| `rproxy-0` | [`plex`](plex.md), [`synology`](synology.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`services`](services.md), [`jenkins`](jenkins.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`plex`](plex.md), [`synology`](synology.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`services`](services.md), [`jenkins`](jenkins.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`plex`](plex.md), [`synology`](synology.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`services`](services.md), [`jenkins`](jenkins.md) | linux, python, rproxy_secondary, vms |
