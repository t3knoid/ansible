...
| `rproxy-0` | [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`services`](services.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`synology`](synology.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`truenas`](truenas.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`services`](services.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`synology`](synology.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`truenas`](truenas.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`services`](services.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`synology`](synology.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`truenas`](truenas.md) | linux, python, rproxy_secondary, vms |
