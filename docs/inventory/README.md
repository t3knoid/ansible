...
| `rproxy-0` | [`ecube`](ecube.md), [`plex`](plex.md), [`ad`](ad.md), [`synology`](synology.md), [`services`](services.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](ecube.md), [`plex`](plex.md), [`ad`](ad.md), [`synology`](synology.md), [`services`](services.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](ecube.md), [`plex`](plex.md), [`ad`](ad.md), [`synology`](synology.md), [`services`](services.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md) | linux, python, rproxy_secondary, vms |
