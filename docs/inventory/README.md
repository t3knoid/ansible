...
| `rproxy-0` | [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`plex`](plex.md), [`grafana`](grafana.md), [`services`](services.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`plex`](plex.md), [`grafana`](grafana.md), [`services`](services.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`plex`](plex.md), [`grafana`](grafana.md), [`services`](services.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
