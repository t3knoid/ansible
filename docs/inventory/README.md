...
| `rproxy-0` | [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`redmine`](redmine.md), [`plex`](plex.md), [`synology`](synology.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`pve`](pve.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`ad`](ad.md), [`services`](services.md), [`rproxy`](rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`redmine`](redmine.md), [`plex`](plex.md), [`synology`](synology.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`pve`](pve.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`ad`](ad.md), [`services`](services.md), [`rproxy`](rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`redmine`](redmine.md), [`plex`](plex.md), [`synology`](synology.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`pve`](pve.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`ad`](ad.md), [`services`](services.md), [`rproxy`](rproxy.md) | linux, python, rproxy_secondary, vms |
