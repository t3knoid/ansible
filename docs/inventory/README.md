...
| `prometheus-0` | [`prometheus`](prometheus.md), [`grafana`](grafana.md) | alertmanager, autofs, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ecube`](ecube.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`pve`](pve.md), [`redmine`](redmine.md), [`services`](services.md), [`ad`](ad.md), [`plex`](plex.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`synology`](synology.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](ecube.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`pve`](pve.md), [`redmine`](redmine.md), [`services`](services.md), [`ad`](ad.md), [`plex`](plex.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`synology`](synology.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](ecube.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`pve`](pve.md), [`redmine`](redmine.md), [`services`](services.md), [`ad`](ad.md), [`plex`](plex.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`synology`](synology.md) | linux, python, rproxy_secondary, vms |
