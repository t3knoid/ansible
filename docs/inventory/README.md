...
| `rproxy-0` | [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`pve`](pve.md), [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`services`](services.md), [`truenas`](truenas.md), [`redmine`](redmine.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`pve`](pve.md), [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`services`](services.md), [`truenas`](truenas.md), [`redmine`](redmine.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`pve`](pve.md), [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`services`](services.md), [`truenas`](truenas.md), [`redmine`](redmine.md) | linux, python, rproxy_secondary, vms |
