...
| `rproxy-0` | [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`services`](services.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`ad`](ad.md), [`plex`](plex.md), [`synology`](synology.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`pve`](pve.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`services`](services.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`ad`](ad.md), [`plex`](plex.md), [`synology`](synology.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`pve`](pve.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`services`](services.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`ad`](ad.md), [`plex`](plex.md), [`synology`](synology.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`pve`](pve.md) | linux, python, rproxy_secondary, vms |
