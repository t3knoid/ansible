...
| `ansible-0` | [`dns`](dns.md), [`ansible`](ansible.md) | azure_cli, code_server, nginx, ruby, vault_clients, vms, vscode |
...
| `rproxy-0` | [`semaphore`](semaphore.md), [`plex`](plex.md), [`synology`](synology.md), [`grafana`](grafana.md), [`pve`](pve.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`services`](services.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`semaphore`](semaphore.md), [`plex`](plex.md), [`synology`](synology.md), [`grafana`](grafana.md), [`pve`](pve.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`services`](services.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`semaphore`](semaphore.md), [`plex`](plex.md), [`synology`](synology.md), [`grafana`](grafana.md), [`pve`](pve.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`services`](services.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md) | linux, python, rproxy_secondary, vms |
