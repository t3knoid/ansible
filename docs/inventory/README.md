...
| `prometheus-0` | [`redmine`](redmine.md), [`plex`](plex.md), [`vpn`](vpn.md), [`prometheus`](prometheus.md), [`services`](services.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`pg`](pg.md), [`minecraft`](minecraft.md), [`semaphore`](semaphore.md), [`dns`](dns.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`truenas`](truenas.md), [`redmine`](redmine.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`services`](services.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`synology`](synology.md), [`ad`](ad.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`truenas`](truenas.md), [`redmine`](redmine.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`services`](services.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`synology`](synology.md), [`ad`](ad.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`truenas`](truenas.md), [`redmine`](redmine.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`services`](services.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`synology`](synology.md), [`ad`](ad.md) | linux, node_exporter, python, rproxy_secondary, vms |
