...
| `rproxy-0` | [`plex`](plex.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`services`](services.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`synology`](synology.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`ansible`](ansible.md), [`redmine`](redmine.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`plex`](plex.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`services`](services.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`synology`](synology.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`ansible`](ansible.md), [`redmine`](redmine.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`plex`](plex.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`services`](services.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`synology`](synology.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`ansible`](ansible.md), [`redmine`](redmine.md) | linux, python, rproxy_secondary, vms |
