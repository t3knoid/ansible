...
| `rproxy-0` | [`ombi`](ombi.md), [`services`](services.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`ad`](ad.md), [`grafana`](grafana.md), [`synology`](synology.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ombi`](ombi.md), [`services`](services.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`ad`](ad.md), [`grafana`](grafana.md), [`synology`](synology.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ombi`](ombi.md), [`services`](services.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`ad`](ad.md), [`grafana`](grafana.md), [`synology`](synology.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md) | linux, python, rproxy_secondary, vms |
