...
| `rproxy-0` | [`ombi`](ombi.md), [`grafana`](grafana.md), [`services`](services.md), [`ad`](ad.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`synology`](synology.md), [`pve`](pve.md), [`semaphore`](semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ombi`](ombi.md), [`grafana`](grafana.md), [`services`](services.md), [`ad`](ad.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`synology`](synology.md), [`pve`](pve.md), [`semaphore`](semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ombi`](ombi.md), [`grafana`](grafana.md), [`services`](services.md), [`ad`](ad.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`synology`](synology.md), [`pve`](pve.md), [`semaphore`](semaphore.md) | linux, python, rproxy_secondary, vms |
