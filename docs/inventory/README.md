...
| `rproxy-0` | [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`pve`](pve.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`services`](services.md), [`rproxy`](rproxy.md), [`ad`](ad.md), [`semaphore`](semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`pve`](pve.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`services`](services.md), [`rproxy`](rproxy.md), [`ad`](ad.md), [`semaphore`](semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`pve`](pve.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`services`](services.md), [`rproxy`](rproxy.md), [`ad`](ad.md), [`semaphore`](semaphore.md) | linux, python, rproxy_secondary, vms |
