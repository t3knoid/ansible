...
| `rproxy-0` | [`redmine`](redmine.md), [`plex`](plex.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`services`](services.md), [`ombi`](ombi.md), [`synology`](synology.md), [`ad`](ad.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](redmine.md), [`plex`](plex.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`services`](services.md), [`ombi`](ombi.md), [`synology`](synology.md), [`ad`](ad.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](redmine.md), [`plex`](plex.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`services`](services.md), [`ombi`](ombi.md), [`synology`](synology.md), [`ad`](ad.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md) | linux, python, rproxy_secondary, vms |
