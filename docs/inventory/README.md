...
| `rproxy-0` | [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`synology`](synology.md), [`plex`](plex.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`synology`](synology.md), [`plex`](plex.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`synology`](synology.md), [`plex`](plex.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
