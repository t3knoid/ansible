...
| `prometheus-0` | [`services`](services.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`pg`](pg.md), [`redmine`](redmine.md), [`minecraft`](minecraft.md), [`dns`](dns.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`vpn`](vpn.md), [`plex`](plex.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`services`](services.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`synology`](synology.md), [`ad`](ad.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`plex`](plex.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`synology`](synology.md), [`ad`](ad.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`plex`](plex.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`synology`](synology.md), [`ad`](ad.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`plex`](plex.md) | linux, node_exporter, python, rproxy_secondary, vms |
