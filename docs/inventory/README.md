...
| `prometheus-0` | [`minecraft`](minecraft.md), [`plex`](plex.md), [`services`](services.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`vpn`](vpn.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`pg`](pg.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`plex`](plex.md), [`services`](services.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`pve`](pve.md), [`redmine`](redmine.md), [`ecube`](ecube.md), [`ansible`](ansible.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`plex`](plex.md), [`services`](services.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`pve`](pve.md), [`redmine`](redmine.md), [`ecube`](ecube.md), [`ansible`](ansible.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`plex`](plex.md), [`services`](services.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`pve`](pve.md), [`redmine`](redmine.md), [`ecube`](ecube.md), [`ansible`](ansible.md) | linux, node_exporter, python, rproxy_secondary, vms |
