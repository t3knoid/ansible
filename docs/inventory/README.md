...
| `rproxy-0` | [`truenas`](truenas.md), [`ad`](ad.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`plex`](plex.md), [`services`](services.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`pve`](pve.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`truenas`](truenas.md), [`ad`](ad.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`plex`](plex.md), [`services`](services.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`pve`](pve.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`truenas`](truenas.md), [`ad`](ad.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`plex`](plex.md), [`services`](services.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`pve`](pve.md) | linux, python, rproxy_secondary, vms |
