...
| `rproxy-0` | [`ombi`](ombi.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`services`](services.md), [`ansible`](ansible.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`pve`](pve.md), [`jenkins`](jenkins.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ombi`](ombi.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`services`](services.md), [`ansible`](ansible.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`pve`](pve.md), [`jenkins`](jenkins.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ombi`](ombi.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`services`](services.md), [`ansible`](ansible.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`pve`](pve.md), [`jenkins`](jenkins.md) | linux, python, rproxy_secondary, vms |
