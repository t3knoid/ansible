...
| `rproxy-0` | [`tautulli`](tautulli.md), [`ad`](ad.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`services`](services.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`pve`](pve.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`plex`](plex.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`tautulli`](tautulli.md), [`ad`](ad.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`services`](services.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`pve`](pve.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`plex`](plex.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`tautulli`](tautulli.md), [`ad`](ad.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`services`](services.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`pve`](pve.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`plex`](plex.md) | linux, python, rproxy_secondary, vms |
