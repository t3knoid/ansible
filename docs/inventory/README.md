...
| `rproxy-0` | [`ecube`](ecube.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`services`](services.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`pve`](pve.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`plex`](plex.md), [`rproxy`](rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](ecube.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`services`](services.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`pve`](pve.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`plex`](plex.md), [`rproxy`](rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](ecube.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`services`](services.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`pve`](pve.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`plex`](plex.md), [`rproxy`](rproxy.md) | linux, python, rproxy_secondary, vms |
