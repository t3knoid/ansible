...
| `prometheus-0` | [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`vpn`](vpn.md), [`dns`](dns.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`pg`](pg.md), [`plex`](plex.md), [`minecraft`](minecraft.md), [`grafana`](grafana.md), [`services`](services.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`plex`](plex.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`ad`](ad.md), [`grafana`](grafana.md), [`synology`](synology.md), [`services`](services.md), [`ecube`](ecube.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`plex`](plex.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`ad`](ad.md), [`grafana`](grafana.md), [`synology`](synology.md), [`services`](services.md), [`ecube`](ecube.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`plex`](plex.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`ad`](ad.md), [`grafana`](grafana.md), [`synology`](synology.md), [`services`](services.md), [`ecube`](ecube.md) | linux, node_exporter, python, rproxy_secondary, vms |
