...
| `rproxy-0` | [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ansible`](ansible.md), [`ad`](ad.md), [`synology`](synology.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`services`](services.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ansible`](ansible.md), [`ad`](ad.md), [`synology`](synology.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`services`](services.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ansible`](ansible.md), [`ad`](ad.md), [`synology`](synology.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`services`](services.md) | linux, python, rproxy_secondary, vms |
