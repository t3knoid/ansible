...
| `prometheus-0` | [`pg`](pg.md), [`dns`](dns.md), [`plex`](plex.md), [`vpn`](vpn.md), [`redmine`](redmine.md), [`minecraft`](minecraft.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`services`](services.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ansible`](ansible.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`plex`](plex.md), [`redmine`](redmine.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`services`](services.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`truenas`](truenas.md), [`ansible`](ansible.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`plex`](plex.md), [`redmine`](redmine.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`services`](services.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`truenas`](truenas.md), [`ansible`](ansible.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`plex`](plex.md), [`redmine`](redmine.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`services`](services.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`truenas`](truenas.md), [`ansible`](ansible.md) | linux, node_exporter, python, rproxy_secondary, vms |
