...
| `rproxy-0` | [`synology`](synology.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`ad`](ad.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`ecube`](ecube.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`services`](services.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`synology`](synology.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`ad`](ad.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`ecube`](ecube.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`services`](services.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`synology`](synology.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`ad`](ad.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`ecube`](ecube.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`services`](services.md) | linux, python, rproxy_secondary, vms |
