...
| `prometheus-0` | [`pg`](pg.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`services`](services.md), [`dns`](dns.md), [`vpn`](vpn.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`minecraft`](minecraft.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`truenas`](truenas.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`services`](services.md), [`jenkins`](jenkins.md), [`ad`](ad.md), [`ecube`](ecube.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`redmine`](redmine.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`truenas`](truenas.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`services`](services.md), [`jenkins`](jenkins.md), [`ad`](ad.md), [`ecube`](ecube.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`redmine`](redmine.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`truenas`](truenas.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`services`](services.md), [`jenkins`](jenkins.md), [`ad`](ad.md), [`ecube`](ecube.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`redmine`](redmine.md) | linux, node_exporter, python, rproxy_secondary, vms |
