...
| `prometheus-0` | [`plex`](plex.md), [`redmine`](redmine.md), [`pg`](pg.md), [`tautulli`](tautulli.md), [`vpn`](vpn.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`services`](services.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`dns`](dns.md), [`minecraft`](minecraft.md), [`grafana`](grafana.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ad`](ad.md), [`plex`](plex.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`services`](services.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](ad.md), [`plex`](plex.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`services`](services.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](ad.md), [`plex`](plex.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`services`](services.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md) | linux, node_exporter, python, rproxy_secondary, vms |
