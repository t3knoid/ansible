...
| `rproxy-0` | [`redmine`](redmine.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ombi`](ombi.md), [`services`](services.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](redmine.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ombi`](ombi.md), [`services`](services.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](redmine.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ombi`](ombi.md), [`services`](services.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md) | linux, python, rproxy_secondary, vms |
