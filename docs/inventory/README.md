...
| `rproxy-0` | [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`grafana`](grafana.md), [`ad`](ad.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`ombi`](ombi.md), [`synology`](synology.md), [`services`](services.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`pve`](pve.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`grafana`](grafana.md), [`ad`](ad.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`ombi`](ombi.md), [`synology`](synology.md), [`services`](services.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`pve`](pve.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`grafana`](grafana.md), [`ad`](ad.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`ombi`](ombi.md), [`synology`](synology.md), [`services`](services.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`pve`](pve.md) | linux, python, rproxy_secondary, vms |
