...
| `prometheus-0` | [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`prometheus`](prometheus.md) | alertmanager, autofs, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ad`](ad.md), [`pve`](pve.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`services`](services.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`plex`](plex.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](ad.md), [`pve`](pve.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`services`](services.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`plex`](plex.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](ad.md), [`pve`](pve.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`services`](services.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`plex`](plex.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md) | linux, python, rproxy_secondary, vms |
