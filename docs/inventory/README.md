...
| `rproxy-0` | [`ansible`](ansible.md), [`synology`](synology.md), [`truenas`](truenas.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`services`](services.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](ansible.md), [`synology`](synology.md), [`truenas`](truenas.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`services`](services.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](ansible.md), [`synology`](synology.md), [`truenas`](truenas.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`services`](services.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
