...
| `prometheus-0` | [`services`](services.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`minecraft`](minecraft.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`plex`](plex.md), [`dns`](dns.md), [`vpn`](vpn.md), [`pg`](pg.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`services`](services.md), [`rproxy`](rproxy.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`plex`](plex.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`grafana`](grafana.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`rproxy`](rproxy.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`plex`](plex.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`grafana`](grafana.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`rproxy`](rproxy.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`plex`](plex.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`grafana`](grafana.md) | linux, node_exporter, python, rproxy_secondary, vms |
