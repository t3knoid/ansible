...
| `rproxy-0` | [`semaphore`](semaphore.md), [`services`](services.md), [`plex`](plex.md), [`ecube`](ecube.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`synology`](synology.md), [`pve`](pve.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`semaphore`](semaphore.md), [`services`](services.md), [`plex`](plex.md), [`ecube`](ecube.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`synology`](synology.md), [`pve`](pve.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`semaphore`](semaphore.md), [`services`](services.md), [`plex`](plex.md), [`ecube`](ecube.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`synology`](synology.md), [`pve`](pve.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md) | linux, python, rproxy_secondary, vms |
