...
| `rproxy-0` | [`truenas`](truenas.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`ecube`](ecube.md), [`ad`](ad.md), [`redmine`](redmine.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`ansible`](ansible.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`services`](services.md), [`ombi`](ombi.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`truenas`](truenas.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`ecube`](ecube.md), [`ad`](ad.md), [`redmine`](redmine.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`ansible`](ansible.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`services`](services.md), [`ombi`](ombi.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`truenas`](truenas.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`ecube`](ecube.md), [`ad`](ad.md), [`redmine`](redmine.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`ansible`](ansible.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`services`](services.md), [`ombi`](ombi.md) | linux, python, rproxy_secondary, vms |
