...
| `rproxy-0` | [`semaphore`](semaphore.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`ad`](ad.md), [`grafana`](grafana.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`truenas`](truenas.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`semaphore`](semaphore.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`ad`](ad.md), [`grafana`](grafana.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`truenas`](truenas.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`semaphore`](semaphore.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`ad`](ad.md), [`grafana`](grafana.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`truenas`](truenas.md) | linux, python, rproxy_secondary, vms |
