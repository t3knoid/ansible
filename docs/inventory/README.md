...
| `prometheus-0` | [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`vpn`](vpn.md), [`semaphore`](semaphore.md), [`services`](services.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`pg`](pg.md), [`minecraft`](minecraft.md), [`ansible`](ansible.md), [`dns`](dns.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`synology`](synology.md), [`ad`](ad.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`services`](services.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`ansible`](ansible.md), [`tautulli`](tautulli.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`synology`](synology.md), [`ad`](ad.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`services`](services.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`ansible`](ansible.md), [`tautulli`](tautulli.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`synology`](synology.md), [`ad`](ad.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`services`](services.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`ansible`](ansible.md), [`tautulli`](tautulli.md) | linux, node_exporter, python, rproxy_secondary, vms |
