...
| `rproxy-0` | [`jenkins`](jenkins.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`services`](services.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`pve`](pve.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`jenkins`](jenkins.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`services`](services.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`pve`](pve.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`jenkins`](jenkins.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`services`](services.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`pve`](pve.md) | linux, python, rproxy_secondary, vms |
