...
| `prometheus-0` | [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`dns`](dns.md), [`vpn`](vpn.md), [`pg`](pg.md), [`minecraft`](minecraft.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`services`](services.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`plex`](plex.md), [`ecube`](ecube.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`ad`](ad.md), [`services`](services.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`plex`](plex.md), [`ecube`](ecube.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`ad`](ad.md), [`services`](services.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`plex`](plex.md), [`ecube`](ecube.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`ad`](ad.md), [`services`](services.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md) | linux, node_exporter, python, rproxy_secondary, vms |
