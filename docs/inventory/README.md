...
| `rproxy-0` | [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`services`](services.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`plex`](plex.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`services`](services.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`plex`](plex.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`services`](services.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`plex`](plex.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
