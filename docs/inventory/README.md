...
| `rproxy-0` | [`services`](services.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`pve`](pve.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`ad`](ad.md), [`truenas`](truenas.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`pve`](pve.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`ad`](ad.md), [`truenas`](truenas.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`pve`](pve.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`ad`](ad.md), [`truenas`](truenas.md) | linux, python, rproxy_secondary, vms |
