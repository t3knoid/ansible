...
| `rproxy-0` | [`ad`](ad.md), [`services`](services.md), [`ansible`](ansible.md), [`plex`](plex.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`synology`](synology.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](ad.md), [`services`](services.md), [`ansible`](ansible.md), [`plex`](plex.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`synology`](synology.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](ad.md), [`services`](services.md), [`ansible`](ansible.md), [`plex`](plex.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`synology`](synology.md) | linux, python, rproxy_secondary, vms |
