...
| `rproxy-0` | [`ecube`](ecube.md), [`synology`](synology.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`plex`](plex.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`services`](services.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](ecube.md), [`synology`](synology.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`plex`](plex.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`services`](services.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](ecube.md), [`synology`](synology.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`plex`](plex.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`services`](services.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
