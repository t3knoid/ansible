...
| `rproxy-0` | [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`services`](services.md), [`plex`](plex.md), [`ansible`](ansible.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`synology`](synology.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`services`](services.md), [`plex`](plex.md), [`ansible`](ansible.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`synology`](synology.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`services`](services.md), [`plex`](plex.md), [`ansible`](ansible.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`synology`](synology.md) | linux, python, rproxy_secondary, vms |
