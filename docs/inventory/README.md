...
| `pg-4` | [`pg`](pg.md), [`grafana`](grafana.md) | autofs, node_exporter, pgdb, python, vms |
| `plex-0` | [`plex`](plex.md) | autofs, baremetal, cname, lamp, linux, node_exporter, plex, pxe_client, python, wikipedia |
| `prometheus-0` | [`minecraft`](minecraft.md), [`grafana`](grafana.md), [`plex`](plex.md), [`services`](services.md), [`prometheus`](prometheus.md), [`pg`](pg.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`vpn`](vpn.md), [`redmine`](redmine.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`ad`](ad.md), [`pve`](pve.md), [`ecube`](ecube.md), [`plex`](plex.md), [`services`](services.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`synology`](synology.md), [`redmine`](redmine.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`ad`](ad.md), [`pve`](pve.md), [`ecube`](ecube.md), [`plex`](plex.md), [`services`](services.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`synology`](synology.md), [`redmine`](redmine.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`ad`](ad.md), [`pve`](pve.md), [`ecube`](ecube.md), [`plex`](plex.md), [`services`](services.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`synology`](synology.md), [`redmine`](redmine.md) | linux, node_exporter, python, rproxy_secondary, vms |
