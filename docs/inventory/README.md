...
| `prometheus-0` | [`dns`](dns.md), [`pg`](pg.md), [`services`](services.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`vpn`](vpn.md), [`tautulli`](tautulli.md), [`minecraft`](minecraft.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`plex`](plex.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`synology`](synology.md), [`services`](services.md), [`rproxy`](rproxy.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`pve`](pve.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`plex`](plex.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`synology`](synology.md), [`services`](services.md), [`rproxy`](rproxy.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`pve`](pve.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`plex`](plex.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`synology`](synology.md), [`services`](services.md), [`rproxy`](rproxy.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`pve`](pve.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`plex`](plex.md) | linux, node_exporter, python, rproxy_secondary, vms |
