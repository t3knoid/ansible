...
| `rproxy-0` | [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`ansible`](ansible.md), [`plex`](plex.md), [`redmine`](redmine.md), [`ad`](ad.md), [`services`](services.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`pve`](pve.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`ansible`](ansible.md), [`plex`](plex.md), [`redmine`](redmine.md), [`ad`](ad.md), [`services`](services.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`pve`](pve.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`ansible`](ansible.md), [`plex`](plex.md), [`redmine`](redmine.md), [`ad`](ad.md), [`services`](services.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`pve`](pve.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md) | linux, python, rproxy_secondary, vms |
