...
| `rproxy-0` | [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`services`](services.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`ad`](ad.md), [`plex`](plex.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`services`](services.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`ad`](ad.md), [`plex`](plex.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`services`](services.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`ad`](ad.md), [`plex`](plex.md) | linux, python, rproxy_secondary, vms |
