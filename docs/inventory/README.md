...
| `rproxy-0` | [`tautulli`](tautulli.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`synology`](synology.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`services`](services.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`tautulli`](tautulli.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`synology`](synology.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`services`](services.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`tautulli`](tautulli.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`synology`](synology.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`services`](services.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
