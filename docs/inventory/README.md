...
| `rproxy-0` | [`ad`](ad.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`plex`](plex.md), [`services`](services.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](ad.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`plex`](plex.md), [`services`](services.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](ad.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`plex`](plex.md), [`services`](services.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md) | linux, python, rproxy_secondary, vms |
