...
| `rproxy-0` | [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`synology`](synology.md), [`grafana`](grafana.md), [`services`](services.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`synology`](synology.md), [`grafana`](grafana.md), [`services`](services.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`synology`](synology.md), [`grafana`](grafana.md), [`services`](services.md) | linux, python, rproxy_secondary, vms |
