...
| `rproxy-0` | [`services`](services.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`synology`](synology.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`synology`](synology.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`synology`](synology.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md) | linux, python, rproxy_secondary, vms |
