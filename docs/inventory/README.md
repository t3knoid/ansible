...
| `rproxy-0` | [`jenkins`](jenkins.md), [`services`](services.md), [`ecube`](ecube.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`synology`](synology.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`ad`](ad.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`jenkins`](jenkins.md), [`services`](services.md), [`ecube`](ecube.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`synology`](synology.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`ad`](ad.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`jenkins`](jenkins.md), [`services`](services.md), [`ecube`](ecube.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`synology`](synology.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`ad`](ad.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md) | linux, python, rproxy_secondary, vms |
