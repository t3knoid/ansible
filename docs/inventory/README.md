...
| `rproxy-0` | [`truenas`](truenas.md), [`ad`](ad.md), [`services`](services.md), [`pve`](pve.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ecube`](ecube.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`truenas`](truenas.md), [`ad`](ad.md), [`services`](services.md), [`pve`](pve.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ecube`](ecube.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`truenas`](truenas.md), [`ad`](ad.md), [`services`](services.md), [`pve`](pve.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ecube`](ecube.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md) | linux, python, rproxy_secondary, vms |
