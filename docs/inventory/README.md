...
| `prometheus-0` | [`redmine`](redmine.md), [`vpn`](vpn.md), [`minecraft`](minecraft.md), [`services`](services.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`pg`](pg.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`plex`](plex.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ecube`](ecube.md), [`ad`](ad.md), [`redmine`](redmine.md), [`pve`](pve.md), [`ansible`](ansible.md), [`services`](services.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`plex`](plex.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](ecube.md), [`ad`](ad.md), [`redmine`](redmine.md), [`pve`](pve.md), [`ansible`](ansible.md), [`services`](services.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`plex`](plex.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](ecube.md), [`ad`](ad.md), [`redmine`](redmine.md), [`pve`](pve.md), [`ansible`](ansible.md), [`services`](services.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`plex`](plex.md) | linux, node_exporter, python, rproxy_secondary, vms |
