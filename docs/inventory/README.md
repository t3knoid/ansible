...
| `ecube-0` | [`ecube`](ecube.md) | cname, ecube, linux, pgdb, python, removable, vms, vscode |
| `ecube-1` | [`ecube`](ecube.md) | cname, ecube, linux, pgdb, python, removable, vms, vscode |
...
| `rproxy-0` | [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`services`](services.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`ad`](ad.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`truenas`](truenas.md), [`plex`](plex.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`services`](services.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`ad`](ad.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`truenas`](truenas.md), [`plex`](plex.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`services`](services.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`ad`](ad.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`truenas`](truenas.md), [`plex`](plex.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md) | linux, python, rproxy_secondary, vms |
