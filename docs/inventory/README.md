...
| `rproxy-0` | [`redmine`](redmine.md), [`grafana`](grafana.md), [`synology`](synology.md), [`services`](services.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](redmine.md), [`grafana`](grafana.md), [`synology`](synology.md), [`services`](services.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](redmine.md), [`grafana`](grafana.md), [`synology`](synology.md), [`services`](services.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md) | linux, python, rproxy_secondary, vms |
