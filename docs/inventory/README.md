...
| `rproxy-0` | [`prometheus`](prometheus.md), [`pve`](pve.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`ad`](ad.md), [`services`](services.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`synology`](synology.md), [`plex`](plex.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`prometheus`](prometheus.md), [`pve`](pve.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`ad`](ad.md), [`services`](services.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`synology`](synology.md), [`plex`](plex.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`prometheus`](prometheus.md), [`pve`](pve.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`ad`](ad.md), [`services`](services.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`synology`](synology.md), [`plex`](plex.md) | linux, python, rproxy_secondary, vms |
