...
| `prometheus-0` | [`services`](services.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`redmine`](redmine.md), [`pg`](pg.md), [`rproxy`](rproxy.md), [`vpn`](vpn.md), [`grafana`](grafana.md), [`dns`](dns.md), [`minecraft`](minecraft.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`services`](services.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`ad`](ad.md), [`pve`](pve.md), [`plex`](plex.md), [`synology`](synology.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`ad`](ad.md), [`pve`](pve.md), [`plex`](plex.md), [`synology`](synology.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`ad`](ad.md), [`pve`](pve.md), [`plex`](plex.md), [`synology`](synology.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md) | linux, node_exporter, python, rproxy_secondary, vms |
