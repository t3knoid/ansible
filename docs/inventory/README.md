...
| `rproxy-0` | [`ad`](ad.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`services`](services.md), [`synology`](synology.md), [`ombi`](ombi.md), [`ansible`](ansible.md), [`plex`](plex.md), [`semaphore`](semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](ad.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`services`](services.md), [`synology`](synology.md), [`ombi`](ombi.md), [`ansible`](ansible.md), [`plex`](plex.md), [`semaphore`](semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](ad.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`services`](services.md), [`synology`](synology.md), [`ombi`](ombi.md), [`ansible`](ansible.md), [`plex`](plex.md), [`semaphore`](semaphore.md) | linux, python, rproxy_secondary, vms |
