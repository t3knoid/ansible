...
| `rproxy-0` | [`rproxy`](rproxy.md), [`ad`](ad.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`ecube`](ecube.md), [`pve`](pve.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`services`](services.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`plex`](plex.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](rproxy.md), [`ad`](ad.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`ecube`](ecube.md), [`pve`](pve.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`services`](services.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`plex`](plex.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](rproxy.md), [`ad`](ad.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`ecube`](ecube.md), [`pve`](pve.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`services`](services.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`plex`](plex.md) | linux, python, rproxy_secondary, vms |
