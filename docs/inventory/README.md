...
| [`loki`](loki.md) | Inventory for `loki` hosts |
...
| `ansible-0` | [`dns`](dns.md), [`ansible`](ansible.md) | azure_cli, code_server, docker, gh_cli, nginx, node_exporter, ruby, vault_clients, vms, vscode |
...
| `dns-1` | [`dns`](dns.md), [`vpn`](vpn.md) | baremetal, cname, dns, docker, linux, node_exporter, primary_dns, pxe_client, python, unbound, vault_servers, vpn |
...
| `lidarr-0` | [`services`](services.md) | autofs, cname, entra_id, lidarr, linux, vms |
...
| `prometheus-0` | [`tautulli`](tautulli.md), [`vpn`](vpn.md), [`services`](services.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`dns`](dns.md), [`rproxy`](rproxy.md), [`minecraft`](minecraft.md), [`pg`](pg.md), [`semaphore`](semaphore.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`tautulli`](tautulli.md), [`plex`](plex.md), [`services`](services.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`ad`](ad.md), [`ansible`](ansible.md), [`pve`](pve.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`synology`](synology.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`tautulli`](tautulli.md), [`plex`](plex.md), [`services`](services.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`ad`](ad.md), [`ansible`](ansible.md), [`pve`](pve.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`synology`](synology.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`tautulli`](tautulli.md), [`plex`](plex.md), [`services`](services.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`ad`](ad.md), [`ansible`](ansible.md), [`pve`](pve.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`synology`](synology.md) | linux, node_exporter, python, rproxy_secondary, vms |
