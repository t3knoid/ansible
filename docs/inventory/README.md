...
| `rproxy-0` | [`ansible`](ansible.md), [`pve`](pve.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`ad`](ad.md), [`ombi`](ombi.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`services`](services.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](ansible.md), [`pve`](pve.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`ad`](ad.md), [`ombi`](ombi.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`services`](services.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](ansible.md), [`pve`](pve.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`ad`](ad.md), [`ombi`](ombi.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`services`](services.md) | linux, python, rproxy_secondary, vms |
