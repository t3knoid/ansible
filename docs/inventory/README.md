...
| `rproxy-0` | [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`ansible`](ansible.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`synology`](synology.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`services`](services.md), [`semaphore`](semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`ansible`](ansible.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`synology`](synology.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`services`](services.md), [`semaphore`](semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`ansible`](ansible.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`synology`](synology.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`services`](services.md), [`semaphore`](semaphore.md) | linux, python, rproxy_secondary, vms |
