...
| `rproxy-0` | [`truenas`](truenas.md), [`synology`](synology.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`tautulli`](tautulli.md), [`services`](services.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`ombi`](ombi.md), [`pve`](pve.md), [`ad`](ad.md), [`redmine`](redmine.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`truenas`](truenas.md), [`synology`](synology.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`tautulli`](tautulli.md), [`services`](services.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`ombi`](ombi.md), [`pve`](pve.md), [`ad`](ad.md), [`redmine`](redmine.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`truenas`](truenas.md), [`synology`](synology.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`tautulli`](tautulli.md), [`services`](services.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`ombi`](ombi.md), [`pve`](pve.md), [`ad`](ad.md), [`redmine`](redmine.md) | linux, python, rproxy_secondary, vms |
