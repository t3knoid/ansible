...
| `rproxy-0` | [`prometheus`](prometheus.md), [`services`](services.md), [`ombi`](ombi.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`ad`](ad.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`ecube`](ecube.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`prometheus`](prometheus.md), [`services`](services.md), [`ombi`](ombi.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`ad`](ad.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`ecube`](ecube.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`prometheus`](prometheus.md), [`services`](services.md), [`ombi`](ombi.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`ad`](ad.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`ecube`](ecube.md) | linux, python, rproxy_secondary, vms |
