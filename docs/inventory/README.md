...
| `rproxy-0` | [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`ad`](ad.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`plex`](plex.md), [`redmine`](redmine.md), [`services`](services.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`ad`](ad.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`plex`](plex.md), [`redmine`](redmine.md), [`services`](services.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`ad`](ad.md), [`ansible`](ansible.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`plex`](plex.md), [`redmine`](redmine.md), [`services`](services.md) | linux, python, rproxy_secondary, vms |
