...
| `rproxy-0` | [`plex`](plex.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`grafana`](grafana.md), [`synology`](synology.md), [`services`](services.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`ecube`](ecube.md), [`ansible`](ansible.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`plex`](plex.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`grafana`](grafana.md), [`synology`](synology.md), [`services`](services.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`ecube`](ecube.md), [`ansible`](ansible.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`plex`](plex.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`grafana`](grafana.md), [`synology`](synology.md), [`services`](services.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`ecube`](ecube.md), [`ansible`](ansible.md) | linux, python, rproxy_secondary, vms |
