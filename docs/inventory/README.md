...
| `rproxy-0` | [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`ecube`](ecube.md), [`pve`](pve.md), [`ad`](ad.md), [`grafana`](grafana.md), [`plex`](plex.md), [`truenas`](truenas.md), [`services`](services.md), [`synology`](synology.md), [`tautulli`](tautulli.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`ecube`](ecube.md), [`pve`](pve.md), [`ad`](ad.md), [`grafana`](grafana.md), [`plex`](plex.md), [`truenas`](truenas.md), [`services`](services.md), [`synology`](synology.md), [`tautulli`](tautulli.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`ecube`](ecube.md), [`pve`](pve.md), [`ad`](ad.md), [`grafana`](grafana.md), [`plex`](plex.md), [`truenas`](truenas.md), [`services`](services.md), [`synology`](synology.md), [`tautulli`](tautulli.md) | linux, python, rproxy_secondary, vms |
