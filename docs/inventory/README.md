...
| `rproxy-0` | [`ansible`](ansible.md), [`ombi`](ombi.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`services`](services.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](ansible.md), [`ombi`](ombi.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`services`](services.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](ansible.md), [`ombi`](ombi.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`services`](services.md), [`plex`](plex.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md) | linux, python, rproxy_secondary, vms |
