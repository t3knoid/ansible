...
| `rproxy-0` | [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`ombi`](ombi.md), [`synology`](synology.md), [`redmine`](redmine.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`services`](services.md), [`jenkins`](jenkins.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`ombi`](ombi.md), [`synology`](synology.md), [`redmine`](redmine.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`services`](services.md), [`jenkins`](jenkins.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`ombi`](ombi.md), [`synology`](synology.md), [`redmine`](redmine.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`services`](services.md), [`jenkins`](jenkins.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md) | linux, python, rproxy_secondary, vms |
