...
| `rproxy-0` | [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`services`](services.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`pve`](pve.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`plex`](plex.md), [`ad`](ad.md), [`synology`](synology.md), [`redmine`](redmine.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`services`](services.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`pve`](pve.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`plex`](plex.md), [`ad`](ad.md), [`synology`](synology.md), [`redmine`](redmine.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`services`](services.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`ecube`](ecube.md), [`pve`](pve.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`plex`](plex.md), [`ad`](ad.md), [`synology`](synology.md), [`redmine`](redmine.md) | linux, python, rproxy_secondary, vms |
