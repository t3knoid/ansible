...
| `rproxy-0` | [`grafana`](grafana.md), [`services`](services.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`ad`](ad.md), [`pve`](pve.md), [`ecube`](ecube.md), [`redmine`](redmine.md), [`plex`](plex.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`ombi`](ombi.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](grafana.md), [`services`](services.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`ad`](ad.md), [`pve`](pve.md), [`ecube`](ecube.md), [`redmine`](redmine.md), [`plex`](plex.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`ombi`](ombi.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](grafana.md), [`services`](services.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`ad`](ad.md), [`pve`](pve.md), [`ecube`](ecube.md), [`redmine`](redmine.md), [`plex`](plex.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`ombi`](ombi.md) | linux, python, rproxy_secondary, vms |
