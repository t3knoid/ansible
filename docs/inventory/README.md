...
| `rproxy-0` | [`plex`](plex.md), [`jenkins`](jenkins.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`synology`](synology.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`plex`](plex.md), [`jenkins`](jenkins.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`synology`](synology.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`plex`](plex.md), [`jenkins`](jenkins.md), [`services`](services.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`redmine`](redmine.md), [`synology`](synology.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
