...
| `rproxy-0` | [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`services`](services.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`synology`](synology.md), [`ansible`](ansible.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`pve`](pve.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`services`](services.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`synology`](synology.md), [`ansible`](ansible.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`pve`](pve.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`services`](services.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`synology`](synology.md), [`ansible`](ansible.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`pve`](pve.md) | linux, python, rproxy_secondary, vms |
