...
| `prometheus-0` | [`plex`](plex.md), [`vpn`](vpn.md), [`pg`](pg.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`minecraft`](minecraft.md), [`services`](services.md), [`dns`](dns.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`pve`](pve.md), [`ad`](ad.md), [`plex`](plex.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`services`](services.md), [`synology`](synology.md), [`ombi`](ombi.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`pve`](pve.md), [`ad`](ad.md), [`plex`](plex.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`services`](services.md), [`synology`](synology.md), [`ombi`](ombi.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`pve`](pve.md), [`ad`](ad.md), [`plex`](plex.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`ecube`](ecube.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`services`](services.md), [`synology`](synology.md), [`ombi`](ombi.md) | linux, node_exporter, python, rproxy_secondary, vms |
