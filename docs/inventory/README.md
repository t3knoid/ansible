...
| `rproxy-0` | [`ansible`](ansible.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`ad`](ad.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`services`](services.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](ansible.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`ad`](ad.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`services`](services.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](ansible.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`ad`](ad.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`services`](services.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md) | linux, python, rproxy_secondary, vms |
