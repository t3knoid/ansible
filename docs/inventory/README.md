...
| `prometheus-0` | [`vpn`](vpn.md), [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`services`](services.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`pg`](pg.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`minecraft`](minecraft.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`services`](services.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ad`](ad.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`services`](services.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ad`](ad.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`services`](services.md), [`rproxy`](rproxy.md), [`pve`](pve.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`plex`](plex.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ad`](ad.md) | linux, node_exporter, python, rproxy_secondary, vms |
