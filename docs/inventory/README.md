...
| `prometheus-0` | [`vpn`](vpn.md), [`semaphore`](semaphore.md), [`pg`](pg.md), [`minecraft`](minecraft.md), [`dns`](dns.md), [`redmine`](redmine.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`services`](services.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`plex`](plex.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`pve`](pve.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`truenas`](truenas.md), [`services`](services.md), [`synology`](synology.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ombi`](ombi.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`pve`](pve.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`truenas`](truenas.md), [`services`](services.md), [`synology`](synology.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ombi`](ombi.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`pve`](pve.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`truenas`](truenas.md), [`services`](services.md), [`synology`](synology.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ombi`](ombi.md) | linux, node_exporter, python, rproxy_secondary, vms |
