...
| `prometheus-0` | [`services`](services.md), [`pg`](pg.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`dns`](dns.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`minecraft`](minecraft.md), [`grafana`](grafana.md), [`vpn`](vpn.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`services`](services.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`synology`](synology.md), [`pve`](pve.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`synology`](synology.md), [`pve`](pve.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`ecube`](ecube.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`synology`](synology.md), [`pve`](pve.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md) | linux, node_exporter, python, rproxy_secondary, vms |
