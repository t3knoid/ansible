...
| `rproxy-0` | [`ansible`](ansible.md), [`pve`](pve.md), [`plex`](plex.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`services`](services.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ad`](ad.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](ansible.md), [`pve`](pve.md), [`plex`](plex.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`services`](services.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ad`](ad.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](ansible.md), [`pve`](pve.md), [`plex`](plex.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`semaphore`](semaphore.md), [`services`](services.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`ad`](ad.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md) | linux, python, rproxy_secondary, vms |
