...
| `rproxy-0` | [`ansible`](ansible.md), [`synology`](synology.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`services`](services.md), [`ecube`](ecube.md), [`ad`](ad.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](ansible.md), [`synology`](synology.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`services`](services.md), [`ecube`](ecube.md), [`ad`](ad.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](ansible.md), [`synology`](synology.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`services`](services.md), [`ecube`](ecube.md), [`ad`](ad.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md) | linux, python, rproxy_secondary, vms |
