...
| `prometheus-0` | [`services`](services.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`dns`](dns.md), [`grafana`](grafana.md), [`vpn`](vpn.md), [`pg`](pg.md), [`plex`](plex.md), [`minecraft`](minecraft.md), [`redmine`](redmine.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`services`](services.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md), [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`ad`](ad.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`redmine`](redmine.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md), [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`ad`](ad.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`redmine`](redmine.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`tautulli`](tautulli.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md), [`ecube`](ecube.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`ad`](ad.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`synology`](synology.md), [`redmine`](redmine.md) | linux, node_exporter, python, rproxy_secondary, vms |
