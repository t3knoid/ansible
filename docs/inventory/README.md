...
| `rproxy-0` | [`pve`](pve.md), [`jenkins`](jenkins.md), [`services`](services.md), [`plex`](plex.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`pve`](pve.md), [`jenkins`](jenkins.md), [`services`](services.md), [`plex`](plex.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`pve`](pve.md), [`jenkins`](jenkins.md), [`services`](services.md), [`plex`](plex.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`synology`](synology.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md) | linux, python, rproxy_secondary, vms |
