...
| `rproxy-0` | [`redmine`](redmine.md), [`services`](services.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`ansible`](ansible.md), [`synology`](synology.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](redmine.md), [`services`](services.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`ansible`](ansible.md), [`synology`](synology.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](redmine.md), [`services`](services.md), [`ombi`](ombi.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`ansible`](ansible.md), [`synology`](synology.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ecube`](ecube.md) | linux, python, rproxy_secondary, vms |
