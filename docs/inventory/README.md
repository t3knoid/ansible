...
| `rproxy-0` | [`pve`](pve.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`synology`](synology.md), [`services`](services.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`truenas`](truenas.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`pve`](pve.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`synology`](synology.md), [`services`](services.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`truenas`](truenas.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`pve`](pve.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`ecube`](ecube.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`synology`](synology.md), [`services`](services.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`truenas`](truenas.md) | linux, python, rproxy_secondary, vms |
