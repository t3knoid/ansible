...
| `prometheus-0` | [`vpn`](vpn.md), [`ansible`](ansible.md), [`minecraft`](minecraft.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`services`](services.md), [`tautulli`](tautulli.md), [`dns`](dns.md), [`plex`](plex.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`pg`](pg.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`services`](services.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`ecube`](ecube.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`synology`](synology.md), [`pve`](pve.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`services`](services.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`ecube`](ecube.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`synology`](synology.md), [`pve`](pve.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`services`](services.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`ecube`](ecube.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`synology`](synology.md), [`pve`](pve.md) | linux, node_exporter, python, rproxy_secondary, vms |
