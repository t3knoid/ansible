...
| `rproxy-0` | [`services`](services.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`ad`](ad.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`synology`](synology.md), [`ombi`](ombi.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`ad`](ad.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`synology`](synology.md), [`ombi`](ombi.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`ad`](ad.md), [`truenas`](truenas.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`pve`](pve.md), [`ecube`](ecube.md), [`rproxy`](rproxy.md), [`synology`](synology.md), [`ombi`](ombi.md) | linux, python, rproxy_secondary, vms |
