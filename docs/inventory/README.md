...
| `rproxy-0` | [`services`](services.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`truenas`](truenas.md), [`plex`](plex.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`truenas`](truenas.md), [`plex`](plex.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`truenas`](truenas.md), [`plex`](plex.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md) | linux, python, rproxy_secondary, vms |
