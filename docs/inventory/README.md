...
| `prometheus-0` | [`pg`](pg.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`services`](services.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`minecraft`](minecraft.md), [`redmine`](redmine.md), [`dns`](dns.md), [`vpn`](vpn.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`plex`](plex.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`services`](services.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`synology`](synology.md), [`redmine`](redmine.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`plex`](plex.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`services`](services.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`synology`](synology.md), [`redmine`](redmine.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`plex`](plex.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`services`](services.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`synology`](synology.md), [`redmine`](redmine.md) | linux, node_exporter, python, rproxy_secondary, vms |
