...
| `rproxy-0` | [`ecube`](ecube.md), [`grafana`](grafana.md), [`ad`](ad.md), [`synology`](synology.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`services`](services.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`ombi`](ombi.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](ecube.md), [`grafana`](grafana.md), [`ad`](ad.md), [`synology`](synology.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`services`](services.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`ombi`](ombi.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](ecube.md), [`grafana`](grafana.md), [`ad`](ad.md), [`synology`](synology.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`services`](services.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`ombi`](ombi.md) | linux, python, rproxy_secondary, vms |
