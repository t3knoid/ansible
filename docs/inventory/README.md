...
| `prometheus-0` | [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`pg`](pg.md), [`prometheus`](prometheus.md) | alertmanager, autofs, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`synology`](synology.md), [`ombi`](ombi.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`services`](services.md), [`tautulli`](tautulli.md), [`ecube`](ecube.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`ad`](ad.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`synology`](synology.md), [`ombi`](ombi.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`services`](services.md), [`tautulli`](tautulli.md), [`ecube`](ecube.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`ad`](ad.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`synology`](synology.md), [`ombi`](ombi.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`prometheus`](prometheus.md), [`services`](services.md), [`tautulli`](tautulli.md), [`ecube`](ecube.md), [`semaphore`](semaphore.md), [`redmine`](redmine.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`ad`](ad.md) | linux, node_exporter, python, rproxy_secondary, vms |
