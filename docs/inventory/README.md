...
| `rproxy-0` | [`ecube`](ecube.md), [`redmine`](redmine.md), [`synology`](synology.md), [`ombi`](ombi.md), [`ad`](ad.md), [`grafana`](grafana.md), [`plex`](plex.md), [`services`](services.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](ecube.md), [`redmine`](redmine.md), [`synology`](synology.md), [`ombi`](ombi.md), [`ad`](ad.md), [`grafana`](grafana.md), [`plex`](plex.md), [`services`](services.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](ecube.md), [`redmine`](redmine.md), [`synology`](synology.md), [`ombi`](ombi.md), [`ad`](ad.md), [`grafana`](grafana.md), [`plex`](plex.md), [`services`](services.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`ansible`](ansible.md) | linux, python, rproxy_secondary, vms |
