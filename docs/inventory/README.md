...
| `rproxy-0` | [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`pve`](pve.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`services`](services.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`ad`](ad.md), [`ansible`](ansible.md), [`truenas`](truenas.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`pve`](pve.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`services`](services.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`ad`](ad.md), [`ansible`](ansible.md), [`truenas`](truenas.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`pve`](pve.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`services`](services.md), [`grafana`](grafana.md), [`ecube`](ecube.md), [`ad`](ad.md), [`ansible`](ansible.md), [`truenas`](truenas.md) | linux, python, rproxy_secondary, vms |
