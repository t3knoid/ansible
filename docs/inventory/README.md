...
| `prometheus-0` | [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`plex`](plex.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`pg`](pg.md), [`services`](services.md), [`dns`](dns.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`vpn`](vpn.md), [`minecraft`](minecraft.md) | alertmanager, autofs, blackbox_exporter, cname, entra_id, linux, prometheus, python, vms |
...
| `rproxy-0` | [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`plex`](plex.md), [`pve`](pve.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`services`](services.md), [`ad`](ad.md), [`ombi`](ombi.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`ecube`](ecube.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`plex`](plex.md), [`pve`](pve.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`services`](services.md), [`ad`](ad.md), [`ombi`](ombi.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`ecube`](ecube.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`plex`](plex.md), [`pve`](pve.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`services`](services.md), [`ad`](ad.md), [`ombi`](ombi.md), [`synology`](synology.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`redmine`](redmine.md), [`ecube`](ecube.md) | linux, node_exporter, python, rproxy_secondary, vms |
