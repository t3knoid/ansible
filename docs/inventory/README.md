...
| `rproxy-0` | [`prometheus`](prometheus.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`services`](services.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`redmine`](redmine.md), [`ad`](ad.md), [`grafana`](grafana.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`prometheus`](prometheus.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`services`](services.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`redmine`](redmine.md), [`ad`](ad.md), [`grafana`](grafana.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`prometheus`](prometheus.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`services`](services.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`plex`](plex.md), [`redmine`](redmine.md), [`ad`](ad.md), [`grafana`](grafana.md) | linux, python, rproxy_secondary, vms |
