...
| `rproxy-0` | [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`pve`](pve.md), [`ad`](ad.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`plex`](plex.md), [`services`](services.md), [`synology`](synology.md), [`grafana`](grafana.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`pve`](pve.md), [`ad`](ad.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`plex`](plex.md), [`services`](services.md), [`synology`](synology.md), [`grafana`](grafana.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`ombi`](ombi.md), [`pve`](pve.md), [`ad`](ad.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`truenas`](truenas.md), [`plex`](plex.md), [`services`](services.md), [`synology`](synology.md), [`grafana`](grafana.md) | linux, python, rproxy_secondary, vms |
