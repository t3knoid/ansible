...
| `prometheus-0` | [`tautulli`](tautulli.md), [`minecraft`](minecraft.md), [`pg`](pg.md), [`grafana`](grafana.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`plex`](plex.md), [`dns`](dns.md), [`semaphore`](semaphore.md), [`vpn`](vpn.md), [`prometheus`](prometheus.md), [`services`](services.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`tautulli`](tautulli.md), [`ecube`](ecube.md), [`truenas`](truenas.md), [`pve`](pve.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`prometheus`](prometheus.md), [`services`](services.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`tautulli`](tautulli.md), [`ecube`](ecube.md), [`truenas`](truenas.md), [`pve`](pve.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`prometheus`](prometheus.md), [`services`](services.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`tautulli`](tautulli.md), [`ecube`](ecube.md), [`truenas`](truenas.md), [`pve`](pve.md), [`ombi`](ombi.md), [`grafana`](grafana.md), [`synology`](synology.md), [`rproxy`](rproxy.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`prometheus`](prometheus.md), [`services`](services.md) | linux, node_exporter, python, rproxy_secondary, vms |
