...
| `rproxy-0` | [`ad`](ad.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`services`](services.md), [`synology`](synology.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`semaphore`](semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](ad.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`services`](services.md), [`synology`](synology.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`semaphore`](semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](ad.md), [`truenas`](truenas.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`services`](services.md), [`synology`](synology.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`semaphore`](semaphore.md) | linux, python, rproxy_secondary, vms |
