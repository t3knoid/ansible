...
| `rproxy-0` | [`services`](services.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`pve`](pve.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`pve`](pve.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`ansible`](ansible.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`plex`](plex.md), [`jenkins`](jenkins.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`pve`](pve.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
