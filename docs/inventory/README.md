...
| `rproxy-0` | [`services`](services.md), [`pve`](pve.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`ad`](ad.md), [`plex`](plex.md), [`ombi`](ombi.md), [`synology`](synology.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](services.md), [`pve`](pve.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`ad`](ad.md), [`plex`](plex.md), [`ombi`](ombi.md), [`synology`](synology.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](services.md), [`pve`](pve.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`tautulli`](tautulli.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`ad`](ad.md), [`plex`](plex.md), [`ombi`](ombi.md), [`synology`](synology.md), [`ansible`](ansible.md), [`rproxy`](rproxy.md) | linux, python, rproxy_secondary, vms |
