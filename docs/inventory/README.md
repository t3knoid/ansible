...
| `rproxy-0` | [`jenkins`](jenkins.md), [`plex`](plex.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`pve`](pve.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`services`](services.md), [`rproxy`](rproxy.md), [`synology`](synology.md), [`semaphore`](semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`jenkins`](jenkins.md), [`plex`](plex.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`pve`](pve.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`services`](services.md), [`rproxy`](rproxy.md), [`synology`](synology.md), [`semaphore`](semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`jenkins`](jenkins.md), [`plex`](plex.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`pve`](pve.md), [`ansible`](ansible.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`ecube`](ecube.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`services`](services.md), [`rproxy`](rproxy.md), [`synology`](synology.md), [`semaphore`](semaphore.md) | linux, python, rproxy_secondary, vms |
