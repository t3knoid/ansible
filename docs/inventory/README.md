...
| `ansible-0` | [`ansible`](ansible.md), [`dns`](dns.md) | azure_cli, code_server, docker, gh_cli, nginx, node_exporter, ruby, vault_clients, vms, vscode |
...
| `prometheus-0` | [`prometheus`](prometheus.md), [`plex`](plex.md), [`pg`](pg.md), [`tautulli`](tautulli.md), [`services`](services.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`minecraft`](minecraft.md), [`vpn`](vpn.md), [`dns`](dns.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`prometheus`](prometheus.md), [`pve`](pve.md), [`plex`](plex.md), [`synology`](synology.md), [`ecube`](ecube.md), [`services`](services.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`prometheus`](prometheus.md), [`pve`](pve.md), [`plex`](plex.md), [`synology`](synology.md), [`ecube`](ecube.md), [`services`](services.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`prometheus`](prometheus.md), [`pve`](pve.md), [`plex`](plex.md), [`synology`](synology.md), [`ecube`](ecube.md), [`services`](services.md), [`tautulli`](tautulli.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`jenkins`](jenkins.md) | linux, node_exporter, python, rproxy_secondary, vms |
