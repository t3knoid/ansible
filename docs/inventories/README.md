...
| `rproxy-0` | [`synology`](synology.md), [`services`](services.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`ombi`](ombi.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`synology`](synology.md), [`services`](services.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`ombi`](ombi.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`synology`](synology.md), [`services`](services.md), [`grafana`](grafana.md), [`semaphore`](semaphore.md), [`pve`](pve.md), [`redmine`](redmine.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`ombi`](ombi.md), [`ansible`](ansible.md), [`prometheus`](prometheus.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
