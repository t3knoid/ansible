...
| `rproxy-0` | [`prometheus`](prometheus.md), [`services`](services.md), [`pve`](pve.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`plex`](plex.md), [`rproxy`](rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`prometheus`](prometheus.md), [`services`](services.md), [`pve`](pve.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`plex`](plex.md), [`rproxy`](rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`prometheus`](prometheus.md), [`services`](services.md), [`pve`](pve.md), [`ansible`](ansible.md), [`semaphore`](semaphore.md), [`grafana`](grafana.md), [`redmine`](redmine.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`ombi`](ombi.md), [`ad`](ad.md), [`tautulli`](tautulli.md), [`synology`](synology.md), [`plex`](plex.md), [`rproxy`](rproxy.md) | linux, python, rproxy_secondary, vms |
