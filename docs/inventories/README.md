...
| `rproxy-0` | [`plex`](plex.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`services`](services.md), [`synology`](synology.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`pve`](pve.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`plex`](plex.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`services`](services.md), [`synology`](synology.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`pve`](pve.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`plex`](plex.md), [`tautulli`](tautulli.md), [`semaphore`](semaphore.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`services`](services.md), [`synology`](synology.md), [`grafana`](grafana.md), [`prometheus`](prometheus.md), [`ad`](ad.md), [`redmine`](redmine.md), [`ombi`](ombi.md), [`truenas`](truenas.md), [`rproxy`](rproxy.md), [`pve`](pve.md) | linux, python, rproxy_secondary, vms |
