...
| `rproxy-0` | [`redmine`](redmine.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`services`](services.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`ansible`](ansible.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`grafana`](grafana.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](redmine.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`services`](services.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`ansible`](ansible.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`grafana`](grafana.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](redmine.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`truenas`](truenas.md), [`services`](services.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`semaphore`](semaphore.md), [`plex`](plex.md), [`ansible`](ansible.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`grafana`](grafana.md) | linux, python, rproxy_secondary, vms |
