...
| `rproxy-0` | [`jenkins`](jenkins.md), [`services`](services.md), [`synology`](synology.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ombi`](ombi.md), [`truenas`](truenas.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`jenkins`](jenkins.md), [`services`](services.md), [`synology`](synology.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ombi`](ombi.md), [`truenas`](truenas.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`jenkins`](jenkins.md), [`services`](services.md), [`synology`](synology.md), [`redmine`](redmine.md), [`semaphore`](semaphore.md), [`rproxy`](rproxy.md), [`grafana`](grafana.md), [`ansible`](ansible.md), [`tautulli`](tautulli.md), [`ad`](ad.md), [`pve`](pve.md), [`prometheus`](prometheus.md), [`plex`](plex.md), [`ombi`](ombi.md), [`truenas`](truenas.md) | linux, python, rproxy_secondary, vms |
