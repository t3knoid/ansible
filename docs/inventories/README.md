...
| `rproxy-0` | [`tautulli`](tautulli.md), [`truenas`](truenas.md), [`pve`](pve.md), [`plex`](plex.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`services`](services.md), [`grafana`](grafana.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`tautulli`](tautulli.md), [`truenas`](truenas.md), [`pve`](pve.md), [`plex`](plex.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`services`](services.md), [`grafana`](grafana.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`tautulli`](tautulli.md), [`truenas`](truenas.md), [`pve`](pve.md), [`plex`](plex.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`prometheus`](prometheus.md), [`synology`](synology.md), [`semaphore`](semaphore.md), [`ad`](ad.md), [`jenkins`](jenkins.md), [`ombi`](ombi.md), [`rproxy`](rproxy.md), [`services`](services.md), [`grafana`](grafana.md) | linux, python, rproxy_secondary, vms |
