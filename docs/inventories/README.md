...
| `rproxy-0` | [`redmine`](redmine.md), [`pve`](pve.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`services`](services.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`plex`](plex.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](redmine.md), [`pve`](pve.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`services`](services.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`plex`](plex.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](redmine.md), [`pve`](pve.md), [`truenas`](truenas.md), [`tautulli`](tautulli.md), [`jenkins`](jenkins.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md), [`services`](services.md), [`synology`](synology.md), [`prometheus`](prometheus.md), [`grafana`](grafana.md), [`ad`](ad.md), [`semaphore`](semaphore.md), [`ansible`](ansible.md), [`plex`](plex.md) | linux, python, rproxy_secondary, vms |
