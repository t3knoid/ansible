...
| `rproxy-0` | [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`synology`](synology.md), [`plex`](plex.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`services`](services.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`synology`](synology.md), [`plex`](plex.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`services`](services.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](ansible.md), [`jenkins`](jenkins.md), [`redmine`](redmine.md), [`grafana`](grafana.md), [`ad`](ad.md), [`rproxy`](rproxy.md), [`synology`](synology.md), [`plex`](plex.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`ombi`](ombi.md), [`services`](services.md), [`pve`](pve.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md) | linux, python, rproxy_secondary, vms |
