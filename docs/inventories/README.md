...
| `rproxy-0` | [`redmine`](redmine.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`ad`](ad.md), [`synology`](synology.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`services`](services.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](redmine.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`ad`](ad.md), [`synology`](synology.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`services`](services.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](redmine.md), [`grafana`](grafana.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`ad`](ad.md), [`synology`](synology.md), [`ombi`](ombi.md), [`semaphore`](semaphore.md), [`services`](services.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`prometheus`](prometheus.md), [`pve`](pve.md), [`rproxy`](rproxy.md), [`truenas`](truenas.md) | linux, python, rproxy_secondary, vms |
