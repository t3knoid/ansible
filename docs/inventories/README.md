...
| `rproxy-0` | [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`services`](services.md), [`grafana`](grafana.md), [`synology`](synology.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`ombi`](ombi.md), [`redmine`](redmine.md), [`ad`](ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`services`](services.md), [`grafana`](grafana.md), [`synology`](synology.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`ombi`](ombi.md), [`redmine`](redmine.md), [`ad`](ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](rproxy.md), [`ansible`](ansible.md), [`services`](services.md), [`grafana`](grafana.md), [`synology`](synology.md), [`truenas`](truenas.md), [`semaphore`](semaphore.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`plex`](plex.md), [`tautulli`](tautulli.md), [`pve`](pve.md), [`ombi`](ombi.md), [`redmine`](redmine.md), [`ad`](ad.md) | linux, python, rproxy_secondary, vms |
