...
| `rproxy-0` | [`grafana`](grafana.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`services`](services.md), [`ad`](ad.md), [`truenas`](truenas.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](grafana.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`services`](services.md), [`ad`](ad.md), [`truenas`](truenas.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](grafana.md), [`plex`](plex.md), [`prometheus`](prometheus.md), [`jenkins`](jenkins.md), [`ansible`](ansible.md), [`redmine`](redmine.md), [`pve`](pve.md), [`semaphore`](semaphore.md), [`services`](services.md), [`ad`](ad.md), [`truenas`](truenas.md), [`synology`](synology.md), [`tautulli`](tautulli.md), [`rproxy`](rproxy.md), [`ombi`](ombi.md) | linux, python, rproxy_secondary, vms |
