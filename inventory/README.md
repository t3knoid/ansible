...
| `pg-2` | [`pg`](../docs/inventory/pg.md), [`redmine`](../docs/inventory/redmine.md) | autofs, pgdb, python, vms |
...
| `rproxy-0` | [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`ecube`](../docs/inventory/ecube.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`redmine`](../docs/inventory/redmine.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`ecube`](../docs/inventory/ecube.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`redmine`](../docs/inventory/redmine.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`ecube`](../docs/inventory/ecube.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`redmine`](../docs/inventory/redmine.md) | linux, python, rproxy_secondary, vms |
