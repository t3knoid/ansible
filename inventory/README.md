...
| `prometheus-0` | [`services`](../docs/inventory/services.md), [`minecraft`](../docs/inventory/minecraft.md), [`semaphore`](../docs/inventory/semaphore.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`vpn`](../docs/inventory/vpn.md), [`pg`](../docs/inventory/pg.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ansible`](../docs/inventory/ansible.md), [`services`](../docs/inventory/services.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md), [`ad`](../docs/inventory/ad.md), [`truenas`](../docs/inventory/truenas.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](../docs/inventory/ansible.md), [`services`](../docs/inventory/services.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md), [`ad`](../docs/inventory/ad.md), [`truenas`](../docs/inventory/truenas.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](../docs/inventory/ansible.md), [`services`](../docs/inventory/services.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md), [`ad`](../docs/inventory/ad.md), [`truenas`](../docs/inventory/truenas.md) | linux, node_exporter, python, rproxy_secondary, vms |
