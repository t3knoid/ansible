...
| `rproxy-0` | [`services`](../docs/inventory/services.md), [`jenkins`](../docs/inventory/jenkins.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`synology`](../docs/inventory/synology.md), [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](../docs/inventory/services.md), [`jenkins`](../docs/inventory/jenkins.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`synology`](../docs/inventory/synology.md), [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](../docs/inventory/services.md), [`jenkins`](../docs/inventory/jenkins.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`synology`](../docs/inventory/synology.md), [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md) | linux, python, rproxy_secondary, vms |
