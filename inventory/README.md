...
| `rproxy-0` | [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md), [`redmine`](../docs/inventory/redmine.md), [`ad`](../docs/inventory/ad.md), [`synology`](../docs/inventory/synology.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md), [`redmine`](../docs/inventory/redmine.md), [`ad`](../docs/inventory/ad.md), [`synology`](../docs/inventory/synology.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md), [`redmine`](../docs/inventory/redmine.md), [`ad`](../docs/inventory/ad.md), [`synology`](../docs/inventory/synology.md) | linux, python, rproxy_secondary, vms |
