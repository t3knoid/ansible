...
| `prometheus-0` | [`tautulli`](../docs/inventory/tautulli.md), [`vpn`](../docs/inventory/vpn.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md), [`pg`](../docs/inventory/pg.md), [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`minecraft`](../docs/inventory/minecraft.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`rproxy`](../docs/inventory/rproxy.md), [`synology`](../docs/inventory/synology.md), [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`prometheus`](../docs/inventory/prometheus.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md), [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`rproxy`](../docs/inventory/rproxy.md), [`synology`](../docs/inventory/synology.md), [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`prometheus`](../docs/inventory/prometheus.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md), [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`rproxy`](../docs/inventory/rproxy.md), [`synology`](../docs/inventory/synology.md), [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`prometheus`](../docs/inventory/prometheus.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md), [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md) | linux, node_exporter, python, rproxy_secondary, vms |
