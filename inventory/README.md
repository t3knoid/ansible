...
| `rproxy-0` | [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`redmine`](../docs/inventory/redmine.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`redmine`](../docs/inventory/redmine.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`redmine`](../docs/inventory/redmine.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md) | linux, python, rproxy_secondary, vms |
