...
| `prometheus-0` | [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`minecraft`](../docs/inventory/minecraft.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`pg`](../docs/inventory/pg.md), [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`vpn`](../docs/inventory/vpn.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`rproxy`](../docs/inventory/rproxy.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`pve`](../docs/inventory/pve.md), [`ecube`](../docs/inventory/ecube.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](../docs/inventory/rproxy.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`pve`](../docs/inventory/pve.md), [`ecube`](../docs/inventory/ecube.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](../docs/inventory/rproxy.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`pve`](../docs/inventory/pve.md), [`ecube`](../docs/inventory/ecube.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, node_exporter, python, rproxy_secondary, vms |
