...
| `pxe-0` | [`dns`](../docs/inventories/dns.md), [`pxe`](../docs/inventories/pxe.md), [`plex`](../docs/inventories/plex.md) | pxe, vms |
...
| `rproxy-0` | [`ad`](../docs/inventories/ad.md), [`redmine`](../docs/inventories/redmine.md), [`pve`](../docs/inventories/pve.md), [`grafana`](../docs/inventories/grafana.md), [`semaphore`](../docs/inventories/semaphore.md), [`services`](../docs/inventories/services.md), [`jenkins`](../docs/inventories/jenkins.md), [`plex`](../docs/inventories/plex.md), [`prometheus`](../docs/inventories/prometheus.md), [`synology`](../docs/inventories/synology.md), [`rproxy`](../docs/inventories/rproxy.md), [`truenas`](../docs/inventories/truenas.md), [`tautulli`](../docs/inventories/tautulli.md), [`ansible`](../docs/inventories/ansible.md), [`ombi`](../docs/inventories/ombi.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](../docs/inventories/ad.md), [`redmine`](../docs/inventories/redmine.md), [`pve`](../docs/inventories/pve.md), [`grafana`](../docs/inventories/grafana.md), [`semaphore`](../docs/inventories/semaphore.md), [`services`](../docs/inventories/services.md), [`jenkins`](../docs/inventories/jenkins.md), [`plex`](../docs/inventories/plex.md), [`prometheus`](../docs/inventories/prometheus.md), [`synology`](../docs/inventories/synology.md), [`rproxy`](../docs/inventories/rproxy.md), [`truenas`](../docs/inventories/truenas.md), [`tautulli`](../docs/inventories/tautulli.md), [`ansible`](../docs/inventories/ansible.md), [`ombi`](../docs/inventories/ombi.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](../docs/inventories/ad.md), [`redmine`](../docs/inventories/redmine.md), [`pve`](../docs/inventories/pve.md), [`grafana`](../docs/inventories/grafana.md), [`semaphore`](../docs/inventories/semaphore.md), [`services`](../docs/inventories/services.md), [`jenkins`](../docs/inventories/jenkins.md), [`plex`](../docs/inventories/plex.md), [`prometheus`](../docs/inventories/prometheus.md), [`synology`](../docs/inventories/synology.md), [`rproxy`](../docs/inventories/rproxy.md), [`truenas`](../docs/inventories/truenas.md), [`tautulli`](../docs/inventories/tautulli.md), [`ansible`](../docs/inventories/ansible.md), [`ombi`](../docs/inventories/ombi.md) | linux, python, rproxy_secondary, vms |
...
| `test-0` | [`test`](../docs/inventories/test.md) | removable, vms |
