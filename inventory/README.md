...
| `rproxy-0` | [`services`](../docs/inventory/services.md), [`pve`](../docs/inventory/pve.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`tautulli`](../docs/inventory/tautulli.md), [`synology`](../docs/inventory/synology.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](../docs/inventory/services.md), [`pve`](../docs/inventory/pve.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`tautulli`](../docs/inventory/tautulli.md), [`synology`](../docs/inventory/synology.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](../docs/inventory/services.md), [`pve`](../docs/inventory/pve.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`tautulli`](../docs/inventory/tautulli.md), [`synology`](../docs/inventory/synology.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md) | linux, python, rproxy_secondary, vms |
