...
| `prometheus-0` | [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md) | alertmanager, autofs, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ad`](../docs/inventory/ad.md), [`pve`](../docs/inventory/pve.md), [`ombi`](../docs/inventory/ombi.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md), [`redmine`](../docs/inventory/redmine.md), [`plex`](../docs/inventory/plex.md), [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`truenas`](../docs/inventory/truenas.md), [`semaphore`](../docs/inventory/semaphore.md), [`synology`](../docs/inventory/synology.md), [`jenkins`](../docs/inventory/jenkins.md), [`tautulli`](../docs/inventory/tautulli.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](../docs/inventory/ad.md), [`pve`](../docs/inventory/pve.md), [`ombi`](../docs/inventory/ombi.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md), [`redmine`](../docs/inventory/redmine.md), [`plex`](../docs/inventory/plex.md), [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`truenas`](../docs/inventory/truenas.md), [`semaphore`](../docs/inventory/semaphore.md), [`synology`](../docs/inventory/synology.md), [`jenkins`](../docs/inventory/jenkins.md), [`tautulli`](../docs/inventory/tautulli.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](../docs/inventory/ad.md), [`pve`](../docs/inventory/pve.md), [`ombi`](../docs/inventory/ombi.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md), [`redmine`](../docs/inventory/redmine.md), [`plex`](../docs/inventory/plex.md), [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`truenas`](../docs/inventory/truenas.md), [`semaphore`](../docs/inventory/semaphore.md), [`synology`](../docs/inventory/synology.md), [`jenkins`](../docs/inventory/jenkins.md), [`tautulli`](../docs/inventory/tautulli.md) | linux, python, rproxy_secondary, vms |
