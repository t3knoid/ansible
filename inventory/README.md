...
| `ansible-0` | [`ansible`](../docs/inventory/ansible.md), [`dns`](../docs/inventory/dns.md) | azure_cli, code_server, nginx, ruby, vault_clients, vms, vscode |
...
| `rproxy-0` | [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`truenas`](../docs/inventory/truenas.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`synology`](../docs/inventory/synology.md), [`tautulli`](../docs/inventory/tautulli.md), [`rproxy`](../docs/inventory/rproxy.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`redmine`](../docs/inventory/redmine.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`truenas`](../docs/inventory/truenas.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`synology`](../docs/inventory/synology.md), [`tautulli`](../docs/inventory/tautulli.md), [`rproxy`](../docs/inventory/rproxy.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`redmine`](../docs/inventory/redmine.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`truenas`](../docs/inventory/truenas.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`synology`](../docs/inventory/synology.md), [`tautulli`](../docs/inventory/tautulli.md), [`rproxy`](../docs/inventory/rproxy.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`redmine`](../docs/inventory/redmine.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md) | linux, python, rproxy_secondary, vms |
