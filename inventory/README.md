...
| `rproxy-0` | [`ansible`](../docs/inventory/ansible.md), [`synology`](../docs/inventory/synology.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`ad`](../docs/inventory/ad.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](../docs/inventory/ansible.md), [`synology`](../docs/inventory/synology.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`ad`](../docs/inventory/ad.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](../docs/inventory/ansible.md), [`synology`](../docs/inventory/synology.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`ad`](../docs/inventory/ad.md) | linux, python, rproxy_secondary, vms |
