...
| `prometheus-0` | [`prometheus`](../docs/inventory/prometheus.md) | alertmanager, autofs, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md), [`pve`](../docs/inventory/pve.md), [`ombi`](../docs/inventory/ombi.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md), [`redmine`](../docs/inventory/redmine.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md), [`pve`](../docs/inventory/pve.md), [`ombi`](../docs/inventory/ombi.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md), [`redmine`](../docs/inventory/redmine.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md), [`pve`](../docs/inventory/pve.md), [`ombi`](../docs/inventory/ombi.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md), [`redmine`](../docs/inventory/redmine.md) | linux, python, rproxy_secondary, vms |
