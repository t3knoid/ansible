...
| `prometheus-0` | [`plex`](../docs/inventory/plex.md), [`dns`](../docs/inventory/dns.md), [`minecraft`](../docs/inventory/minecraft.md), [`prometheus`](../docs/inventory/prometheus.md), [`pg`](../docs/inventory/pg.md), [`tautulli`](../docs/inventory/tautulli.md), [`vpn`](../docs/inventory/vpn.md), [`semaphore`](../docs/inventory/semaphore.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`grafana`](../docs/inventory/grafana.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`plex`](../docs/inventory/plex.md), [`ecube`](../docs/inventory/ecube.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`synology`](../docs/inventory/synology.md), [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md), [`semaphore`](../docs/inventory/semaphore.md), [`jenkins`](../docs/inventory/jenkins.md), [`rproxy`](../docs/inventory/rproxy.md), [`ombi`](../docs/inventory/ombi.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`grafana`](../docs/inventory/grafana.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`plex`](../docs/inventory/plex.md), [`ecube`](../docs/inventory/ecube.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`synology`](../docs/inventory/synology.md), [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md), [`semaphore`](../docs/inventory/semaphore.md), [`jenkins`](../docs/inventory/jenkins.md), [`rproxy`](../docs/inventory/rproxy.md), [`ombi`](../docs/inventory/ombi.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`grafana`](../docs/inventory/grafana.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`plex`](../docs/inventory/plex.md), [`ecube`](../docs/inventory/ecube.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`synology`](../docs/inventory/synology.md), [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md), [`semaphore`](../docs/inventory/semaphore.md), [`jenkins`](../docs/inventory/jenkins.md), [`rproxy`](../docs/inventory/rproxy.md), [`ombi`](../docs/inventory/ombi.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`grafana`](../docs/inventory/grafana.md) | linux, node_exporter, python, rproxy_secondary, vms |
