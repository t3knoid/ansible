...
| `prometheus-0` | [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`tautulli`](../docs/inventory/tautulli.md), [`prometheus`](../docs/inventory/prometheus.md), [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`plex`](../docs/inventory/plex.md), [`minecraft`](../docs/inventory/minecraft.md), [`pg`](../docs/inventory/pg.md), [`vpn`](../docs/inventory/vpn.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md), [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md), [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md), [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md) | linux, node_exporter, python, rproxy_secondary, vms |
