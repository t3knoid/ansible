...
| `prometheus-0` | [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`vpn`](../docs/inventory/vpn.md), [`minecraft`](../docs/inventory/minecraft.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`pg`](../docs/inventory/pg.md), [`redmine`](../docs/inventory/redmine.md), [`semaphore`](../docs/inventory/semaphore.md) | alertmanager, autofs, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`services`](../docs/inventory/services.md), [`ad`](../docs/inventory/ad.md), [`jenkins`](../docs/inventory/jenkins.md), [`ecube`](../docs/inventory/ecube.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`semaphore`](../docs/inventory/semaphore.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](../docs/inventory/services.md), [`ad`](../docs/inventory/ad.md), [`jenkins`](../docs/inventory/jenkins.md), [`ecube`](../docs/inventory/ecube.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](../docs/inventory/services.md), [`ad`](../docs/inventory/ad.md), [`jenkins`](../docs/inventory/jenkins.md), [`ecube`](../docs/inventory/ecube.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, node_exporter, python, rproxy_secondary, vms |
