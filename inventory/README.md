...
| `prometheus-0` | [`vpn`](../docs/inventory/vpn.md), [`grafana`](../docs/inventory/grafana.md), [`plex`](../docs/inventory/plex.md), [`dns`](../docs/inventory/dns.md), [`services`](../docs/inventory/services.md), [`minecraft`](../docs/inventory/minecraft.md), [`prometheus`](../docs/inventory/prometheus.md), [`rproxy`](../docs/inventory/rproxy.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`pg`](../docs/inventory/pg.md), [`tautulli`](../docs/inventory/tautulli.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md), [`grafana`](../docs/inventory/grafana.md), [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`ad`](../docs/inventory/ad.md), [`prometheus`](../docs/inventory/prometheus.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`semaphore`](../docs/inventory/semaphore.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`synology`](../docs/inventory/synology.md), [`tautulli`](../docs/inventory/tautulli.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md), [`grafana`](../docs/inventory/grafana.md), [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`ad`](../docs/inventory/ad.md), [`prometheus`](../docs/inventory/prometheus.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`semaphore`](../docs/inventory/semaphore.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`synology`](../docs/inventory/synology.md), [`tautulli`](../docs/inventory/tautulli.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md), [`grafana`](../docs/inventory/grafana.md), [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`ad`](../docs/inventory/ad.md), [`prometheus`](../docs/inventory/prometheus.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`semaphore`](../docs/inventory/semaphore.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`synology`](../docs/inventory/synology.md), [`tautulli`](../docs/inventory/tautulli.md) | linux, node_exporter, python, rproxy_secondary, vms |
