...
| `prometheus-0` | [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`vpn`](../docs/inventory/vpn.md), [`minecraft`](../docs/inventory/minecraft.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`pg`](../docs/inventory/pg.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`redmine`](../docs/inventory/redmine.md), [`ansible`](../docs/inventory/ansible.md), [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`services`](../docs/inventory/services.md), [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md), [`synology`](../docs/inventory/synology.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](../docs/inventory/redmine.md), [`ansible`](../docs/inventory/ansible.md), [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`services`](../docs/inventory/services.md), [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md), [`synology`](../docs/inventory/synology.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](../docs/inventory/redmine.md), [`ansible`](../docs/inventory/ansible.md), [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`services`](../docs/inventory/services.md), [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md), [`synology`](../docs/inventory/synology.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md) | linux, node_exporter, python, rproxy_secondary, vms |
