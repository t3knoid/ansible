...
| `rproxy-0` | [`ansible`](../docs/inventory/ansible.md), [`truenas`](../docs/inventory/truenas.md), [`grafana`](../docs/inventory/grafana.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`prometheus`](../docs/inventory/prometheus.md), [`synology`](../docs/inventory/synology.md), [`ad`](../docs/inventory/ad.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](../docs/inventory/ansible.md), [`truenas`](../docs/inventory/truenas.md), [`grafana`](../docs/inventory/grafana.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`prometheus`](../docs/inventory/prometheus.md), [`synology`](../docs/inventory/synology.md), [`ad`](../docs/inventory/ad.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](../docs/inventory/ansible.md), [`truenas`](../docs/inventory/truenas.md), [`grafana`](../docs/inventory/grafana.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`prometheus`](../docs/inventory/prometheus.md), [`synology`](../docs/inventory/synology.md), [`ad`](../docs/inventory/ad.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md) | linux, python, rproxy_secondary, vms |
