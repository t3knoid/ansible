...
| `rproxy-0` | [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md), [`pve`](../docs/inventory/pve.md), [`prometheus`](../docs/inventory/prometheus.md), [`synology`](../docs/inventory/synology.md), [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md), [`pve`](../docs/inventory/pve.md), [`prometheus`](../docs/inventory/prometheus.md), [`synology`](../docs/inventory/synology.md), [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`ombi`](../docs/inventory/ombi.md), [`jenkins`](../docs/inventory/jenkins.md), [`pve`](../docs/inventory/pve.md), [`prometheus`](../docs/inventory/prometheus.md), [`synology`](../docs/inventory/synology.md), [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, python, rproxy_secondary, vms |
