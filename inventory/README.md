...
| `rproxy-0` | [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md) | linux, python, rproxy_secondary, vms |
