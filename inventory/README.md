...
| `prometheus-0` | [`redmine`](../docs/inventory/redmine.md), [`prometheus`](../docs/inventory/prometheus.md), [`vpn`](../docs/inventory/vpn.md), [`grafana`](../docs/inventory/grafana.md), [`dns`](../docs/inventory/dns.md), [`minecraft`](../docs/inventory/minecraft.md), [`tautulli`](../docs/inventory/tautulli.md), [`pg`](../docs/inventory/pg.md), [`plex`](../docs/inventory/plex.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`prometheus`](../docs/inventory/prometheus.md), [`ombi`](../docs/inventory/ombi.md), [`truenas`](../docs/inventory/truenas.md), [`ecube`](../docs/inventory/ecube.md), [`pve`](../docs/inventory/pve.md), [`grafana`](../docs/inventory/grafana.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`synology`](../docs/inventory/synology.md), [`plex`](../docs/inventory/plex.md), [`rproxy`](../docs/inventory/rproxy.md), [`ad`](../docs/inventory/ad.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`prometheus`](../docs/inventory/prometheus.md), [`ombi`](../docs/inventory/ombi.md), [`truenas`](../docs/inventory/truenas.md), [`ecube`](../docs/inventory/ecube.md), [`pve`](../docs/inventory/pve.md), [`grafana`](../docs/inventory/grafana.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`synology`](../docs/inventory/synology.md), [`plex`](../docs/inventory/plex.md), [`rproxy`](../docs/inventory/rproxy.md), [`ad`](../docs/inventory/ad.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`prometheus`](../docs/inventory/prometheus.md), [`ombi`](../docs/inventory/ombi.md), [`truenas`](../docs/inventory/truenas.md), [`ecube`](../docs/inventory/ecube.md), [`pve`](../docs/inventory/pve.md), [`grafana`](../docs/inventory/grafana.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`synology`](../docs/inventory/synology.md), [`plex`](../docs/inventory/plex.md), [`rproxy`](../docs/inventory/rproxy.md), [`ad`](../docs/inventory/ad.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, node_exporter, python, rproxy_secondary, vms |
