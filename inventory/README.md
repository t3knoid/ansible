...
| `rproxy-0` | [`services`](../docs/inventory/services.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`jenkins`](../docs/inventory/jenkins.md), [`prometheus`](../docs/inventory/prometheus.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`ad`](../docs/inventory/ad.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`services`](../docs/inventory/services.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`jenkins`](../docs/inventory/jenkins.md), [`prometheus`](../docs/inventory/prometheus.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`ad`](../docs/inventory/ad.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`services`](../docs/inventory/services.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`jenkins`](../docs/inventory/jenkins.md), [`prometheus`](../docs/inventory/prometheus.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`ad`](../docs/inventory/ad.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md) | linux, python, rproxy_secondary, vms |
