...
| `ansible-0` | [`ansible`](../docs/inventory/ansible.md), [`dns`](../docs/inventory/dns.md) | azure_cli, code_server, docker, gh_cli, nginx, ruby, vault_clients, vms, vscode |
...
| `prometheus-0` | [`pg`](../docs/inventory/pg.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`minecraft`](../docs/inventory/minecraft.md), [`tautulli`](../docs/inventory/tautulli.md), [`dns`](../docs/inventory/dns.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`rproxy`](../docs/inventory/rproxy.md), [`vpn`](../docs/inventory/vpn.md), [`semaphore`](../docs/inventory/semaphore.md), [`services`](../docs/inventory/services.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`synology`](../docs/inventory/synology.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`ansible`](../docs/inventory/ansible.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md), [`rproxy`](../docs/inventory/rproxy.md), [`ecube`](../docs/inventory/ecube.md), [`ombi`](../docs/inventory/ombi.md), [`services`](../docs/inventory/services.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`synology`](../docs/inventory/synology.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`ansible`](../docs/inventory/ansible.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md), [`rproxy`](../docs/inventory/rproxy.md), [`ecube`](../docs/inventory/ecube.md), [`ombi`](../docs/inventory/ombi.md), [`services`](../docs/inventory/services.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`synology`](../docs/inventory/synology.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`ansible`](../docs/inventory/ansible.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md), [`rproxy`](../docs/inventory/rproxy.md), [`ecube`](../docs/inventory/ecube.md), [`ombi`](../docs/inventory/ombi.md), [`services`](../docs/inventory/services.md) | linux, node_exporter, python, rproxy_secondary, vms |
