...
| `ansible-0` | [`ansible`](../docs/inventories/ansible.md), [`dns`](../docs/inventories/dns.md) | ansible, azure_cli, code_server, linux, nginx, python, ruby, vault_clients, vscode |
...
| `dns-0` | [`dns`](../docs/inventories/dns.md) | dns, linux, python, secondary_dns, vms |
| `dns-1` | [`dns`](../docs/inventories/dns.md) | baremetal, cname, dns, linux, primary_dns, pxe_client, python, vault_servers |
...
| `pg-0` | [`pg`](../docs/inventories/pg.md), [`ombi`](../docs/inventories/ombi.md) | autofs, pgdb, python, vms |
| `pg-1` | [`services`](../docs/inventories/services.md), [`pg`](../docs/inventories/pg.md) | autofs, pgdb, python, vms |
| `pg-2` | [`pg`](../docs/inventories/pg.md), [`redmine`](../docs/inventories/redmine.md) | autofs, pgdb, python, vms |
| `pg-3` | [`semaphore`](../docs/inventories/semaphore.md), [`pg`](../docs/inventories/pg.md) | autofs, pgdb, python, vms |
| `pg-4` | [`grafana`](../docs/inventories/grafana.md), [`pg`](../docs/inventories/pg.md) | autofs, pgdb, python, vms |
...
| `pxe-0` | [`pxe`](../docs/inventories/pxe.md), [`dns`](../docs/inventories/dns.md), [`plex`](../docs/inventories/plex.md) | pxe, vms |
...
| `rproxy-0` | [`ad`](../docs/inventories/ad.md), [`rproxy`](../docs/inventories/rproxy.md), [`truenas`](../docs/inventories/truenas.md), [`jenkins`](../docs/inventories/jenkins.md), [`grafana`](../docs/inventories/grafana.md), [`ansible`](../docs/inventories/ansible.md), [`pve`](../docs/inventories/pve.md), [`redmine`](../docs/inventories/redmine.md), [`ombi`](../docs/inventories/ombi.md), [`services`](../docs/inventories/services.md), [`semaphore`](../docs/inventories/semaphore.md), [`tautulli`](../docs/inventories/tautulli.md), [`plex`](../docs/inventories/plex.md), [`prometheus`](../docs/inventories/prometheus.md), [`synology`](../docs/inventories/synology.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](../docs/inventories/ad.md), [`rproxy`](../docs/inventories/rproxy.md), [`truenas`](../docs/inventories/truenas.md), [`jenkins`](../docs/inventories/jenkins.md), [`grafana`](../docs/inventories/grafana.md), [`ansible`](../docs/inventories/ansible.md), [`pve`](../docs/inventories/pve.md), [`redmine`](../docs/inventories/redmine.md), [`ombi`](../docs/inventories/ombi.md), [`services`](../docs/inventories/services.md), [`semaphore`](../docs/inventories/semaphore.md), [`tautulli`](../docs/inventories/tautulli.md), [`plex`](../docs/inventories/plex.md), [`prometheus`](../docs/inventories/prometheus.md), [`synology`](../docs/inventories/synology.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](../docs/inventories/ad.md), [`rproxy`](../docs/inventories/rproxy.md), [`truenas`](../docs/inventories/truenas.md), [`jenkins`](../docs/inventories/jenkins.md), [`grafana`](../docs/inventories/grafana.md), [`ansible`](../docs/inventories/ansible.md), [`pve`](../docs/inventories/pve.md), [`redmine`](../docs/inventories/redmine.md), [`ombi`](../docs/inventories/ombi.md), [`services`](../docs/inventories/services.md), [`semaphore`](../docs/inventories/semaphore.md), [`tautulli`](../docs/inventories/tautulli.md), [`plex`](../docs/inventories/plex.md), [`prometheus`](../docs/inventories/prometheus.md), [`synology`](../docs/inventories/synology.md) | linux, python, rproxy_secondary, vms |
