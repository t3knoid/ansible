...
| `rproxy-0` | [`ecube`](../docs/inventory/ecube.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`synology`](../docs/inventory/synology.md), [`redmine`](../docs/inventory/redmine.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`pve`](../docs/inventory/pve.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](../docs/inventory/ecube.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`synology`](../docs/inventory/synology.md), [`redmine`](../docs/inventory/redmine.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`pve`](../docs/inventory/pve.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](../docs/inventory/ecube.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`synology`](../docs/inventory/synology.md), [`redmine`](../docs/inventory/redmine.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`pve`](../docs/inventory/pve.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md) | linux, python, rproxy_secondary, vms |
