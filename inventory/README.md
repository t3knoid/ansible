...
| `prometheus-0` | [`tautulli`](../docs/inventory/tautulli.md), [`minecraft`](../docs/inventory/minecraft.md), [`pg`](../docs/inventory/pg.md), [`grafana`](../docs/inventory/grafana.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`plex`](../docs/inventory/plex.md), [`dns`](../docs/inventory/dns.md), [`semaphore`](../docs/inventory/semaphore.md), [`vpn`](../docs/inventory/vpn.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`tautulli`](../docs/inventory/tautulli.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md), [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`synology`](../docs/inventory/synology.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`ansible`](../docs/inventory/ansible.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`tautulli`](../docs/inventory/tautulli.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md), [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`synology`](../docs/inventory/synology.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`ansible`](../docs/inventory/ansible.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`tautulli`](../docs/inventory/tautulli.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md), [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`synology`](../docs/inventory/synology.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`ansible`](../docs/inventory/ansible.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md) | linux, node_exporter, python, rproxy_secondary, vms |
