...
| `pg-1` | [`pg`](../docs/inventory/pg.md), [`services`](../docs/inventory/services.md) | autofs, node_exporter, pgdb, python, vms |
| `pg-2` | [`redmine`](../docs/inventory/redmine.md), [`pg`](../docs/inventory/pg.md) | autofs, node_exporter, pgdb, python, vms |
| `pg-3` | [`pg`](../docs/inventory/pg.md), [`semaphore`](../docs/inventory/semaphore.md) | autofs, node_exporter, pgdb, python, vms |
...
| `prometheus-0` | [`redmine`](../docs/inventory/redmine.md), [`vpn`](../docs/inventory/vpn.md), [`minecraft`](../docs/inventory/minecraft.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`rproxy`](../docs/inventory/rproxy.md), [`pg`](../docs/inventory/pg.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`plex`](../docs/inventory/plex.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ecube`](../docs/inventory/ecube.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`pve`](../docs/inventory/pve.md), [`ansible`](../docs/inventory/ansible.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`semaphore`](../docs/inventory/semaphore.md), [`synology`](../docs/inventory/synology.md), [`ombi`](../docs/inventory/ombi.md), [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`plex`](../docs/inventory/plex.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](../docs/inventory/ecube.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`pve`](../docs/inventory/pve.md), [`ansible`](../docs/inventory/ansible.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`semaphore`](../docs/inventory/semaphore.md), [`synology`](../docs/inventory/synology.md), [`ombi`](../docs/inventory/ombi.md), [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`plex`](../docs/inventory/plex.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](../docs/inventory/ecube.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`pve`](../docs/inventory/pve.md), [`ansible`](../docs/inventory/ansible.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`semaphore`](../docs/inventory/semaphore.md), [`synology`](../docs/inventory/synology.md), [`ombi`](../docs/inventory/ombi.md), [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`plex`](../docs/inventory/plex.md) | linux, node_exporter, python, rproxy_secondary, vms |
