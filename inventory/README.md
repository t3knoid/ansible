...
| `prometheus-0` | [`prometheus`](../docs/inventory/prometheus.md), [`vpn`](../docs/inventory/vpn.md), [`grafana`](../docs/inventory/grafana.md), [`minecraft`](../docs/inventory/minecraft.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`pg`](../docs/inventory/pg.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md) | alertmanager, autofs, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`prometheus`](../docs/inventory/prometheus.md), [`synology`](../docs/inventory/synology.md), [`grafana`](../docs/inventory/grafana.md), [`ecube`](../docs/inventory/ecube.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`prometheus`](../docs/inventory/prometheus.md), [`synology`](../docs/inventory/synology.md), [`grafana`](../docs/inventory/grafana.md), [`ecube`](../docs/inventory/ecube.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`prometheus`](../docs/inventory/prometheus.md), [`synology`](../docs/inventory/synology.md), [`grafana`](../docs/inventory/grafana.md), [`ecube`](../docs/inventory/ecube.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md) | linux, node_exporter, python, rproxy_secondary, vms |
