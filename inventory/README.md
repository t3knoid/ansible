...
| `rproxy-0` | [`grafana`](../docs/inventory/grafana.md), [`jenkins`](../docs/inventory/jenkins.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](../docs/inventory/grafana.md), [`jenkins`](../docs/inventory/jenkins.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](../docs/inventory/grafana.md), [`jenkins`](../docs/inventory/jenkins.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, python, rproxy_secondary, vms |
