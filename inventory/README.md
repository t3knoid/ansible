...
| `prometheus-0` | [`vpn`](../docs/inventory/vpn.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`pg`](../docs/inventory/pg.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`minecraft`](../docs/inventory/minecraft.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ecube`](../docs/inventory/ecube.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`synology`](../docs/inventory/synology.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`jenkins`](../docs/inventory/jenkins.md), [`ad`](../docs/inventory/ad.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](../docs/inventory/ecube.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`synology`](../docs/inventory/synology.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`jenkins`](../docs/inventory/jenkins.md), [`ad`](../docs/inventory/ad.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](../docs/inventory/ecube.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`synology`](../docs/inventory/synology.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`jenkins`](../docs/inventory/jenkins.md), [`ad`](../docs/inventory/ad.md) | linux, node_exporter, python, rproxy_secondary, vms |
