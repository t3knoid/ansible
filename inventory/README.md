...
| `prometheus-0` | [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`dns`](../docs/inventory/dns.md), [`pg`](../docs/inventory/pg.md), [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`minecraft`](../docs/inventory/minecraft.md), [`ansible`](../docs/inventory/ansible.md), [`vpn`](../docs/inventory/vpn.md), [`redmine`](../docs/inventory/redmine.md), [`semaphore`](../docs/inventory/semaphore.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`ombi`](../docs/inventory/ombi.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`ecube`](../docs/inventory/ecube.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`synology`](../docs/inventory/synology.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`ombi`](../docs/inventory/ombi.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`ecube`](../docs/inventory/ecube.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`synology`](../docs/inventory/synology.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`ombi`](../docs/inventory/ombi.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`ecube`](../docs/inventory/ecube.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`synology`](../docs/inventory/synology.md), [`truenas`](../docs/inventory/truenas.md), [`pve`](../docs/inventory/pve.md) | linux, node_exporter, python, rproxy_secondary, vms |
