...
| `prometheus-0` | [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`vpn`](../docs/inventory/vpn.md), [`plex`](../docs/inventory/plex.md), [`pg`](../docs/inventory/pg.md), [`grafana`](../docs/inventory/grafana.md), [`minecraft`](../docs/inventory/minecraft.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`ombi`](../docs/inventory/ombi.md), [`ansible`](../docs/inventory/ansible.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md), [`pve`](../docs/inventory/pve.md), [`grafana`](../docs/inventory/grafana.md), [`synology`](../docs/inventory/synology.md), [`truenas`](../docs/inventory/truenas.md), [`ecube`](../docs/inventory/ecube.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`ombi`](../docs/inventory/ombi.md), [`ansible`](../docs/inventory/ansible.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md), [`pve`](../docs/inventory/pve.md), [`grafana`](../docs/inventory/grafana.md), [`synology`](../docs/inventory/synology.md), [`truenas`](../docs/inventory/truenas.md), [`ecube`](../docs/inventory/ecube.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`ombi`](../docs/inventory/ombi.md), [`ansible`](../docs/inventory/ansible.md), [`tautulli`](../docs/inventory/tautulli.md), [`plex`](../docs/inventory/plex.md), [`pve`](../docs/inventory/pve.md), [`grafana`](../docs/inventory/grafana.md), [`synology`](../docs/inventory/synology.md), [`truenas`](../docs/inventory/truenas.md), [`ecube`](../docs/inventory/ecube.md) | linux, node_exporter, python, rproxy_secondary, vms |
