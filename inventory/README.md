...
| `rproxy-0` | [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`plex`](../docs/inventory/plex.md), [`ansible`](../docs/inventory/ansible.md), [`services`](../docs/inventory/services.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`truenas`](../docs/inventory/truenas.md), [`prometheus`](../docs/inventory/prometheus.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`plex`](../docs/inventory/plex.md), [`ansible`](../docs/inventory/ansible.md), [`services`](../docs/inventory/services.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`truenas`](../docs/inventory/truenas.md), [`prometheus`](../docs/inventory/prometheus.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`plex`](../docs/inventory/plex.md), [`ansible`](../docs/inventory/ansible.md), [`services`](../docs/inventory/services.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`truenas`](../docs/inventory/truenas.md), [`prometheus`](../docs/inventory/prometheus.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md) | linux, python, rproxy_secondary, vms |
