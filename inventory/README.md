...
| `prometheus-0` | [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md) | alertmanager, autofs, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ecube`](../docs/inventory/ecube.md), [`grafana`](../docs/inventory/grafana.md), [`jenkins`](../docs/inventory/jenkins.md), [`rproxy`](../docs/inventory/rproxy.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`semaphore`](../docs/inventory/semaphore.md), [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`ad`](../docs/inventory/ad.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](../docs/inventory/ecube.md), [`grafana`](../docs/inventory/grafana.md), [`jenkins`](../docs/inventory/jenkins.md), [`rproxy`](../docs/inventory/rproxy.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`semaphore`](../docs/inventory/semaphore.md), [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`ad`](../docs/inventory/ad.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](../docs/inventory/ecube.md), [`grafana`](../docs/inventory/grafana.md), [`jenkins`](../docs/inventory/jenkins.md), [`rproxy`](../docs/inventory/rproxy.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`semaphore`](../docs/inventory/semaphore.md), [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`ad`](../docs/inventory/ad.md), [`plex`](../docs/inventory/plex.md), [`ombi`](../docs/inventory/ombi.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md) | linux, python, rproxy_secondary, vms |
