...
| `prometheus-0` | [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`minecraft`](../docs/inventory/minecraft.md), [`tautulli`](../docs/inventory/tautulli.md), [`vpn`](../docs/inventory/vpn.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`pg`](../docs/inventory/pg.md) | alertmanager, autofs, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`jenkins`](../docs/inventory/jenkins.md), [`pve`](../docs/inventory/pve.md), [`ecube`](../docs/inventory/ecube.md), [`plex`](../docs/inventory/plex.md), [`ad`](../docs/inventory/ad.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`jenkins`](../docs/inventory/jenkins.md), [`pve`](../docs/inventory/pve.md), [`ecube`](../docs/inventory/ecube.md), [`plex`](../docs/inventory/plex.md), [`ad`](../docs/inventory/ad.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`jenkins`](../docs/inventory/jenkins.md), [`pve`](../docs/inventory/pve.md), [`ecube`](../docs/inventory/ecube.md), [`plex`](../docs/inventory/plex.md), [`ad`](../docs/inventory/ad.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md) | linux, node_exporter, python, rproxy_secondary, vms |
