...
| `pg-3` | [`pg`](../docs/inventories/pg.md), [`semaphore`](../docs/inventories/semaphore.md) | autofs, pgdb, python, vms |
...
| `pxe-0` | [`plex`](../docs/inventories/plex.md), [`pxe`](../docs/inventories/pxe.md), [`dns`](../docs/inventories/dns.md) | pxe, vms |
...
| `rproxy-0` | [`jenkins`](../docs/inventories/jenkins.md), [`services`](../docs/inventories/services.md), [`synology`](../docs/inventories/synology.md), [`redmine`](../docs/inventories/redmine.md), [`semaphore`](../docs/inventories/semaphore.md), [`rproxy`](../docs/inventories/rproxy.md), [`grafana`](../docs/inventories/grafana.md), [`ansible`](../docs/inventories/ansible.md), [`tautulli`](../docs/inventories/tautulli.md), [`ad`](../docs/inventories/ad.md), [`pve`](../docs/inventories/pve.md), [`prometheus`](../docs/inventories/prometheus.md), [`plex`](../docs/inventories/plex.md), [`ombi`](../docs/inventories/ombi.md), [`truenas`](../docs/inventories/truenas.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`jenkins`](../docs/inventories/jenkins.md), [`services`](../docs/inventories/services.md), [`synology`](../docs/inventories/synology.md), [`redmine`](../docs/inventories/redmine.md), [`semaphore`](../docs/inventories/semaphore.md), [`rproxy`](../docs/inventories/rproxy.md), [`grafana`](../docs/inventories/grafana.md), [`ansible`](../docs/inventories/ansible.md), [`tautulli`](../docs/inventories/tautulli.md), [`ad`](../docs/inventories/ad.md), [`pve`](../docs/inventories/pve.md), [`prometheus`](../docs/inventories/prometheus.md), [`plex`](../docs/inventories/plex.md), [`ombi`](../docs/inventories/ombi.md), [`truenas`](../docs/inventories/truenas.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`jenkins`](../docs/inventories/jenkins.md), [`services`](../docs/inventories/services.md), [`synology`](../docs/inventories/synology.md), [`redmine`](../docs/inventories/redmine.md), [`semaphore`](../docs/inventories/semaphore.md), [`rproxy`](../docs/inventories/rproxy.md), [`grafana`](../docs/inventories/grafana.md), [`ansible`](../docs/inventories/ansible.md), [`tautulli`](../docs/inventories/tautulli.md), [`ad`](../docs/inventories/ad.md), [`pve`](../docs/inventories/pve.md), [`prometheus`](../docs/inventories/prometheus.md), [`plex`](../docs/inventories/plex.md), [`ombi`](../docs/inventories/ombi.md), [`truenas`](../docs/inventories/truenas.md) | linux, python, rproxy_secondary, vms |
