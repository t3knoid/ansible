...
| `prometheus-0` | [`vpn`](../docs/inventory/vpn.md), [`semaphore`](../docs/inventory/semaphore.md), [`pg`](../docs/inventory/pg.md), [`minecraft`](../docs/inventory/minecraft.md), [`dns`](../docs/inventory/dns.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`tautulli`](../docs/inventory/tautulli.md), [`services`](../docs/inventory/services.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`plex`](../docs/inventory/plex.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`plex`](../docs/inventory/plex.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`rproxy`](../docs/inventory/rproxy.md), [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`ombi`](../docs/inventory/ombi.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`plex`](../docs/inventory/plex.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`rproxy`](../docs/inventory/rproxy.md), [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`ombi`](../docs/inventory/ombi.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`plex`](../docs/inventory/plex.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`rproxy`](../docs/inventory/rproxy.md), [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`ombi`](../docs/inventory/ombi.md) | linux, node_exporter, python, rproxy_secondary, vms |
