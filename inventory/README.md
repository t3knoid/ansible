...
| `dns-1` | [`vpn`](../docs/inventory/vpn.md), [`dns`](../docs/inventory/dns.md) | baremetal, cname, dns, docker, linux, node_exporter, primary_dns, pxe_client, python, unbound, vault_servers, vpn |
...
| `prometheus-0` | [`prometheus`](../docs/inventory/prometheus.md), [`plex`](../docs/inventory/plex.md), [`pg`](../docs/inventory/pg.md), [`tautulli`](../docs/inventory/tautulli.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`minecraft`](../docs/inventory/minecraft.md), [`vpn`](../docs/inventory/vpn.md), [`dns`](../docs/inventory/dns.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`plex`](../docs/inventory/plex.md), [`synology`](../docs/inventory/synology.md), [`ecube`](../docs/inventory/ecube.md), [`services`](../docs/inventory/services.md), [`tautulli`](../docs/inventory/tautulli.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`jenkins`](../docs/inventory/jenkins.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`plex`](../docs/inventory/plex.md), [`synology`](../docs/inventory/synology.md), [`ecube`](../docs/inventory/ecube.md), [`services`](../docs/inventory/services.md), [`tautulli`](../docs/inventory/tautulli.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`jenkins`](../docs/inventory/jenkins.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`plex`](../docs/inventory/plex.md), [`synology`](../docs/inventory/synology.md), [`ecube`](../docs/inventory/ecube.md), [`services`](../docs/inventory/services.md), [`tautulli`](../docs/inventory/tautulli.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`jenkins`](../docs/inventory/jenkins.md) | linux, node_exporter, python, rproxy_secondary, vms |
