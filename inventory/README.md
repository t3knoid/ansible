...
| `rproxy-0` | [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`grafana`](../docs/inventory/grafana.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`grafana`](../docs/inventory/grafana.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`grafana`](../docs/inventory/grafana.md) | linux, python, rproxy_secondary, vms |
