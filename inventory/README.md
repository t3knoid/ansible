...
| `rproxy-0` | [`grafana`](../docs/inventory/grafana.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`prometheus`](../docs/inventory/prometheus.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`plex`](../docs/inventory/plex.md), [`jenkins`](../docs/inventory/jenkins.md), [`semaphore`](../docs/inventory/semaphore.md), [`synology`](../docs/inventory/synology.md), [`ecube`](../docs/inventory/ecube.md), [`ad`](../docs/inventory/ad.md), [`rproxy`](../docs/inventory/rproxy.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](../docs/inventory/grafana.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`prometheus`](../docs/inventory/prometheus.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`plex`](../docs/inventory/plex.md), [`jenkins`](../docs/inventory/jenkins.md), [`semaphore`](../docs/inventory/semaphore.md), [`synology`](../docs/inventory/synology.md), [`ecube`](../docs/inventory/ecube.md), [`ad`](../docs/inventory/ad.md), [`rproxy`](../docs/inventory/rproxy.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](../docs/inventory/grafana.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`prometheus`](../docs/inventory/prometheus.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`plex`](../docs/inventory/plex.md), [`jenkins`](../docs/inventory/jenkins.md), [`semaphore`](../docs/inventory/semaphore.md), [`synology`](../docs/inventory/synology.md), [`ecube`](../docs/inventory/ecube.md), [`ad`](../docs/inventory/ad.md), [`rproxy`](../docs/inventory/rproxy.md) | linux, python, rproxy_secondary, vms |
