...
| `ecube-0` | [`ecube`](../docs/inventory/ecube.md) | cname, linux, pgdb, python, removable, vms, vscode |
| `ecube-1` | [`ecube`](../docs/inventory/ecube.md) | cname, linux, pgdb, python, removable, vms, vscode |
...
| `rproxy-0` | [`redmine`](../docs/inventory/redmine.md), [`pve`](../docs/inventory/pve.md), [`synology`](../docs/inventory/synology.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`ecube`](../docs/inventory/ecube.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`grafana`](../docs/inventory/grafana.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](../docs/inventory/redmine.md), [`pve`](../docs/inventory/pve.md), [`synology`](../docs/inventory/synology.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`ecube`](../docs/inventory/ecube.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`grafana`](../docs/inventory/grafana.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](../docs/inventory/redmine.md), [`pve`](../docs/inventory/pve.md), [`synology`](../docs/inventory/synology.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`ecube`](../docs/inventory/ecube.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`grafana`](../docs/inventory/grafana.md) | linux, python, rproxy_secondary, vms |
