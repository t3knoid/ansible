...
| `rproxy-0` | [`truenas`](../docs/inventory/truenas.md), [`ansible`](../docs/inventory/ansible.md), [`services`](../docs/inventory/services.md), [`pve`](../docs/inventory/pve.md), [`ombi`](../docs/inventory/ombi.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`jenkins`](../docs/inventory/jenkins.md), [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`prometheus`](../docs/inventory/prometheus.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`synology`](../docs/inventory/synology.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`truenas`](../docs/inventory/truenas.md), [`ansible`](../docs/inventory/ansible.md), [`services`](../docs/inventory/services.md), [`pve`](../docs/inventory/pve.md), [`ombi`](../docs/inventory/ombi.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`jenkins`](../docs/inventory/jenkins.md), [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`prometheus`](../docs/inventory/prometheus.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`synology`](../docs/inventory/synology.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`truenas`](../docs/inventory/truenas.md), [`ansible`](../docs/inventory/ansible.md), [`services`](../docs/inventory/services.md), [`pve`](../docs/inventory/pve.md), [`ombi`](../docs/inventory/ombi.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`jenkins`](../docs/inventory/jenkins.md), [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`prometheus`](../docs/inventory/prometheus.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`synology`](../docs/inventory/synology.md) | linux, python, rproxy_secondary, vms |
