...
| `prometheus-0` | [`tautulli`](../docs/inventory/tautulli.md), [`minecraft`](../docs/inventory/minecraft.md), [`grafana`](../docs/inventory/grafana.md), [`vpn`](../docs/inventory/vpn.md), [`services`](../docs/inventory/services.md), [`pg`](../docs/inventory/pg.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md) | alertmanager, autofs, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`tautulli`](../docs/inventory/tautulli.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`grafana`](../docs/inventory/grafana.md), [`pve`](../docs/inventory/pve.md), [`ansible`](../docs/inventory/ansible.md), [`synology`](../docs/inventory/synology.md), [`services`](../docs/inventory/services.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`prometheus`](../docs/inventory/prometheus.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`tautulli`](../docs/inventory/tautulli.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`grafana`](../docs/inventory/grafana.md), [`pve`](../docs/inventory/pve.md), [`ansible`](../docs/inventory/ansible.md), [`synology`](../docs/inventory/synology.md), [`services`](../docs/inventory/services.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`prometheus`](../docs/inventory/prometheus.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`tautulli`](../docs/inventory/tautulli.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`grafana`](../docs/inventory/grafana.md), [`pve`](../docs/inventory/pve.md), [`ansible`](../docs/inventory/ansible.md), [`synology`](../docs/inventory/synology.md), [`services`](../docs/inventory/services.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`prometheus`](../docs/inventory/prometheus.md) | linux, node_exporter, python, rproxy_secondary, vms |
