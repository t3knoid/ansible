...
| `rproxy-0` | [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`synology`](../docs/inventory/synology.md), [`services`](../docs/inventory/services.md), [`ansible`](../docs/inventory/ansible.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`ad`](../docs/inventory/ad.md), [`truenas`](../docs/inventory/truenas.md), [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`synology`](../docs/inventory/synology.md), [`services`](../docs/inventory/services.md), [`ansible`](../docs/inventory/ansible.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`ad`](../docs/inventory/ad.md), [`truenas`](../docs/inventory/truenas.md), [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`synology`](../docs/inventory/synology.md), [`services`](../docs/inventory/services.md), [`ansible`](../docs/inventory/ansible.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`ad`](../docs/inventory/ad.md), [`truenas`](../docs/inventory/truenas.md), [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`rproxy`](../docs/inventory/rproxy.md), [`jenkins`](../docs/inventory/jenkins.md) | linux, python, rproxy_secondary, vms |
