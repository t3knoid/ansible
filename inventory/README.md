...
| `rproxy-0` | [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`ansible`](../docs/inventory/ansible.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`ansible`](../docs/inventory/ansible.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md), [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`truenas`](../docs/inventory/truenas.md), [`ansible`](../docs/inventory/ansible.md) | linux, python, rproxy_secondary, vms |
