...
| `rproxy-0` | [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`ansible`](../docs/inventory/ansible.md), [`prometheus`](../docs/inventory/prometheus.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`rproxy`](../docs/inventory/rproxy.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`ansible`](../docs/inventory/ansible.md), [`prometheus`](../docs/inventory/prometheus.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`rproxy`](../docs/inventory/rproxy.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`ansible`](../docs/inventory/ansible.md), [`prometheus`](../docs/inventory/prometheus.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`rproxy`](../docs/inventory/rproxy.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md) | linux, python, rproxy_secondary, vms |
