...
| `prometheus-0` | [`plex`](../docs/inventory/plex.md), [`minecraft`](../docs/inventory/minecraft.md), [`prometheus`](../docs/inventory/prometheus.md), [`dns`](../docs/inventory/dns.md), [`grafana`](../docs/inventory/grafana.md), [`semaphore`](../docs/inventory/semaphore.md), [`services`](../docs/inventory/services.md), [`pg`](../docs/inventory/pg.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`tautulli`](../docs/inventory/tautulli.md), [`redmine`](../docs/inventory/redmine.md), [`vpn`](../docs/inventory/vpn.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`plex`](../docs/inventory/plex.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`semaphore`](../docs/inventory/semaphore.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`plex`](../docs/inventory/plex.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`semaphore`](../docs/inventory/semaphore.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`plex`](../docs/inventory/plex.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`grafana`](../docs/inventory/grafana.md), [`semaphore`](../docs/inventory/semaphore.md), [`services`](../docs/inventory/services.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`ansible`](../docs/inventory/ansible.md), [`pve`](../docs/inventory/pve.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md) | linux, node_exporter, python, rproxy_secondary, vms |
