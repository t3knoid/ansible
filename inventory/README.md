...
| `ecube-0` | [`ecube`](../docs/inventory/ecube.md) | cname, ecube, linux, pgdb, python, removable, vms, vscode |
| `ecube-1` | [`ecube`](../docs/inventory/ecube.md) | cname, ecube, linux, pgdb, python, removable, vms, vscode |
...
| `pg-0` | [`ombi`](../docs/inventory/ombi.md), [`pg`](../docs/inventory/pg.md) | autofs, pgdb, python, vms |
| `pg-1` | [`services`](../docs/inventory/services.md), [`pg`](../docs/inventory/pg.md) | autofs, pgdb, python, vms |
| `pg-2` | [`redmine`](../docs/inventory/redmine.md), [`pg`](../docs/inventory/pg.md) | autofs, pgdb, python, vms |
| `pg-3` | [`pg`](../docs/inventory/pg.md), [`semaphore`](../docs/inventory/semaphore.md) | autofs, pgdb, python, vms |
| `pg-4` | [`grafana`](../docs/inventory/grafana.md), [`pg`](../docs/inventory/pg.md) | autofs, pgdb, python, vms |
...
| `rproxy-0` | [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`services`](../docs/inventory/services.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`rproxy`](../docs/inventory/rproxy.md), [`truenas`](../docs/inventory/truenas.md), [`ansible`](../docs/inventory/ansible.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`ecube`](../docs/inventory/ecube.md), [`synology`](../docs/inventory/synology.md), [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`services`](../docs/inventory/services.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`rproxy`](../docs/inventory/rproxy.md), [`truenas`](../docs/inventory/truenas.md), [`ansible`](../docs/inventory/ansible.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`ecube`](../docs/inventory/ecube.md), [`synology`](../docs/inventory/synology.md), [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`services`](../docs/inventory/services.md), [`ad`](../docs/inventory/ad.md), [`redmine`](../docs/inventory/redmine.md), [`tautulli`](../docs/inventory/tautulli.md), [`rproxy`](../docs/inventory/rproxy.md), [`truenas`](../docs/inventory/truenas.md), [`ansible`](../docs/inventory/ansible.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`prometheus`](../docs/inventory/prometheus.md), [`ecube`](../docs/inventory/ecube.md), [`synology`](../docs/inventory/synology.md), [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, python, rproxy_secondary, vms |
