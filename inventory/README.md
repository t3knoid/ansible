...
| `prometheus-0` | [`tautulli`](../docs/inventory/tautulli.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`minecraft`](../docs/inventory/minecraft.md), [`pg`](../docs/inventory/pg.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`vpn`](../docs/inventory/vpn.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`plex`](../docs/inventory/plex.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`prometheus`](../docs/inventory/prometheus.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`plex`](../docs/inventory/plex.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`prometheus`](../docs/inventory/prometheus.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`rproxy`](../docs/inventory/rproxy.md), [`plex`](../docs/inventory/plex.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`prometheus`](../docs/inventory/prometheus.md), [`ecube`](../docs/inventory/ecube.md), [`truenas`](../docs/inventory/truenas.md), [`synology`](../docs/inventory/synology.md) | linux, node_exporter, python, rproxy_secondary, vms |
