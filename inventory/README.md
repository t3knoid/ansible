...
| `prometheus-0` | [`rproxy`](../docs/inventory/rproxy.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`vpn`](../docs/inventory/vpn.md), [`pg`](../docs/inventory/pg.md), [`prometheus`](../docs/inventory/prometheus.md), [`minecraft`](../docs/inventory/minecraft.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`grafana`](../docs/inventory/grafana.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`rproxy`](../docs/inventory/rproxy.md), [`synology`](../docs/inventory/synology.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`ad`](../docs/inventory/ad.md), [`jenkins`](../docs/inventory/jenkins.md), [`prometheus`](../docs/inventory/prometheus.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](../docs/inventory/rproxy.md), [`synology`](../docs/inventory/synology.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`ad`](../docs/inventory/ad.md), [`jenkins`](../docs/inventory/jenkins.md), [`prometheus`](../docs/inventory/prometheus.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](../docs/inventory/rproxy.md), [`synology`](../docs/inventory/synology.md), [`redmine`](../docs/inventory/redmine.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`ad`](../docs/inventory/ad.md), [`jenkins`](../docs/inventory/jenkins.md), [`prometheus`](../docs/inventory/prometheus.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md), [`tautulli`](../docs/inventory/tautulli.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md) | linux, node_exporter, python, rproxy_secondary, vms |
