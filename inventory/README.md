...
| `prometheus-0` | [`grafana`](../docs/inventory/grafana.md), [`pg`](../docs/inventory/pg.md), [`vpn`](../docs/inventory/vpn.md), [`tautulli`](../docs/inventory/tautulli.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`minecraft`](../docs/inventory/minecraft.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ad`](../docs/inventory/ad.md), [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`synology`](../docs/inventory/synology.md), [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](../docs/inventory/ad.md), [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`synology`](../docs/inventory/synology.md), [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](../docs/inventory/ad.md), [`ombi`](../docs/inventory/ombi.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`prometheus`](../docs/inventory/prometheus.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`synology`](../docs/inventory/synology.md), [`pve`](../docs/inventory/pve.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md) | linux, node_exporter, python, rproxy_secondary, vms |
