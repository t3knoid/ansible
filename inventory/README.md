...
| `prometheus-0` | [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`vpn`](../docs/inventory/vpn.md), [`rproxy`](../docs/inventory/rproxy.md), [`minecraft`](../docs/inventory/minecraft.md), [`pg`](../docs/inventory/pg.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ecube`](../docs/inventory/ecube.md), [`synology`](../docs/inventory/synology.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`truenas`](../docs/inventory/truenas.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ecube`](../docs/inventory/ecube.md), [`synology`](../docs/inventory/synology.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`truenas`](../docs/inventory/truenas.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`ecube`](../docs/inventory/ecube.md), [`synology`](../docs/inventory/synology.md), [`services`](../docs/inventory/services.md), [`semaphore`](../docs/inventory/semaphore.md), [`truenas`](../docs/inventory/truenas.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`ansible`](../docs/inventory/ansible.md) | linux, node_exporter, python, rproxy_secondary, vms |
