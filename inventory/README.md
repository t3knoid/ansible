...
| `prometheus-0` | [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`minecraft`](../docs/inventory/minecraft.md), [`pg`](../docs/inventory/pg.md), [`prometheus`](../docs/inventory/prometheus.md), [`plex`](../docs/inventory/plex.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`dns`](../docs/inventory/dns.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`vpn`](../docs/inventory/vpn.md), [`redmine`](../docs/inventory/redmine.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`ecube`](../docs/inventory/ecube.md), [`ad`](../docs/inventory/ad.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`ombi`](../docs/inventory/ombi.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`ecube`](../docs/inventory/ecube.md), [`ad`](../docs/inventory/ad.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`ombi`](../docs/inventory/ombi.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`ecube`](../docs/inventory/ecube.md), [`ad`](../docs/inventory/ad.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`plex`](../docs/inventory/plex.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`jenkins`](../docs/inventory/jenkins.md), [`ombi`](../docs/inventory/ombi.md) | linux, node_exporter, python, rproxy_secondary, vms |
