...
| `ansible-0` | [`dns`](../docs/inventory/dns.md), [`ansible`](../docs/inventory/ansible.md) | ansible, azure_cli, code_server, linux, nginx, python, ruby, vault_clients, vscode |
...
| `rproxy-0` | [`plex`](../docs/inventory/plex.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`synology`](../docs/inventory/synology.md), [`redmine`](../docs/inventory/redmine.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`plex`](../docs/inventory/plex.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`synology`](../docs/inventory/synology.md), [`redmine`](../docs/inventory/redmine.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`plex`](../docs/inventory/plex.md), [`pve`](../docs/inventory/pve.md), [`truenas`](../docs/inventory/truenas.md), [`ombi`](../docs/inventory/ombi.md), [`semaphore`](../docs/inventory/semaphore.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md), [`tautulli`](../docs/inventory/tautulli.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`synology`](../docs/inventory/synology.md), [`redmine`](../docs/inventory/redmine.md) | linux, python, rproxy_secondary, vms |
