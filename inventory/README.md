...
| `ansible-0` | [`dns`](../docs/inventory/dns.md), [`ansible`](../docs/inventory/ansible.md) | azure_cli, code_server, docker, nginx, ruby, vault_clients, vms, vscode |
...
| `rproxy-0` | [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`ombi`](../docs/inventory/ombi.md), [`tautulli`](../docs/inventory/tautulli.md), [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`ombi`](../docs/inventory/ombi.md), [`tautulli`](../docs/inventory/tautulli.md), [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`ombi`](../docs/inventory/ombi.md), [`tautulli`](../docs/inventory/tautulli.md), [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`ansible`](../docs/inventory/ansible.md) | linux, python, rproxy_secondary, vms |
