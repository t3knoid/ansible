...
| `prometheus-0` | [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`services`](../docs/inventory/services.md), [`vpn`](../docs/inventory/vpn.md), [`redmine`](../docs/inventory/redmine.md), [`minecraft`](../docs/inventory/minecraft.md), [`semaphore`](../docs/inventory/semaphore.md), [`rproxy`](../docs/inventory/rproxy.md), [`pg`](../docs/inventory/pg.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`truenas`](../docs/inventory/truenas.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`synology`](../docs/inventory/synology.md), [`tautulli`](../docs/inventory/tautulli.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`ombi`](../docs/inventory/ombi.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`ansible`](../docs/inventory/ansible.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`truenas`](../docs/inventory/truenas.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`synology`](../docs/inventory/synology.md), [`tautulli`](../docs/inventory/tautulli.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`ombi`](../docs/inventory/ombi.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`ansible`](../docs/inventory/ansible.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`truenas`](../docs/inventory/truenas.md), [`jenkins`](../docs/inventory/jenkins.md), [`plex`](../docs/inventory/plex.md), [`synology`](../docs/inventory/synology.md), [`tautulli`](../docs/inventory/tautulli.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`ombi`](../docs/inventory/ombi.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`ansible`](../docs/inventory/ansible.md) | linux, node_exporter, python, rproxy_secondary, vms |
