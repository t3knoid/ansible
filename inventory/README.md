...
| `prometheus-0` | [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`minecraft`](../docs/inventory/minecraft.md), [`pg`](../docs/inventory/pg.md), [`plex`](../docs/inventory/plex.md), [`vpn`](../docs/inventory/vpn.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`ansible`](../docs/inventory/ansible.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`ecube`](../docs/inventory/ecube.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ansible`](../docs/inventory/ansible.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`ecube`](../docs/inventory/ecube.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`ansible`](../docs/inventory/ansible.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`ad`](../docs/inventory/ad.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`grafana`](../docs/inventory/grafana.md), [`ombi`](../docs/inventory/ombi.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`plex`](../docs/inventory/plex.md), [`ecube`](../docs/inventory/ecube.md), [`rproxy`](../docs/inventory/rproxy.md), [`services`](../docs/inventory/services.md), [`redmine`](../docs/inventory/redmine.md) | linux, node_exporter, python, rproxy_secondary, vms |
