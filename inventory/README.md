...
| `rproxy-0` | [`ad`](../docs/inventory/ad.md), [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`redmine`](../docs/inventory/redmine.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`ombi`](../docs/inventory/ombi.md), [`ansible`](../docs/inventory/ansible.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`ad`](../docs/inventory/ad.md), [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`redmine`](../docs/inventory/redmine.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`ombi`](../docs/inventory/ombi.md), [`ansible`](../docs/inventory/ansible.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`ad`](../docs/inventory/ad.md), [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`truenas`](../docs/inventory/truenas.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`redmine`](../docs/inventory/redmine.md), [`pve`](../docs/inventory/pve.md), [`jenkins`](../docs/inventory/jenkins.md), [`services`](../docs/inventory/services.md), [`synology`](../docs/inventory/synology.md), [`ombi`](../docs/inventory/ombi.md), [`ansible`](../docs/inventory/ansible.md), [`plex`](../docs/inventory/plex.md), [`semaphore`](../docs/inventory/semaphore.md) | linux, python, rproxy_secondary, vms |
