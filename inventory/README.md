...
| `prometheus-0` | [`rproxy`](../docs/inventory/rproxy.md), [`dns`](../docs/inventory/dns.md), [`redmine`](../docs/inventory/redmine.md), [`minecraft`](../docs/inventory/minecraft.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`pg`](../docs/inventory/pg.md), [`plex`](../docs/inventory/plex.md), [`vpn`](../docs/inventory/vpn.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`services`](../docs/inventory/services.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`ombi`](../docs/inventory/ombi.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`synology`](../docs/inventory/synology.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`ombi`](../docs/inventory/ombi.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`synology`](../docs/inventory/synology.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`rproxy`](../docs/inventory/rproxy.md), [`pve`](../docs/inventory/pve.md), [`ad`](../docs/inventory/ad.md), [`ecube`](../docs/inventory/ecube.md), [`jenkins`](../docs/inventory/jenkins.md), [`redmine`](../docs/inventory/redmine.md), [`ombi`](../docs/inventory/ombi.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`synology`](../docs/inventory/synology.md), [`plex`](../docs/inventory/plex.md), [`tautulli`](../docs/inventory/tautulli.md), [`semaphore`](../docs/inventory/semaphore.md), [`ansible`](../docs/inventory/ansible.md), [`truenas`](../docs/inventory/truenas.md), [`services`](../docs/inventory/services.md) | linux, node_exporter, python, rproxy_secondary, vms |
