...
| `prometheus-0` | [`rproxy`](../docs/inventory/rproxy.md), [`grafana`](../docs/inventory/grafana.md), [`pg`](../docs/inventory/pg.md), [`prometheus`](../docs/inventory/prometheus.md) | alertmanager, autofs, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`synology`](../docs/inventory/synology.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`tautulli`](../docs/inventory/tautulli.md), [`ecube`](../docs/inventory/ecube.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`plex`](../docs/inventory/plex.md), [`jenkins`](../docs/inventory/jenkins.md), [`truenas`](../docs/inventory/truenas.md), [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`ad`](../docs/inventory/ad.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`synology`](../docs/inventory/synology.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`tautulli`](../docs/inventory/tautulli.md), [`ecube`](../docs/inventory/ecube.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`plex`](../docs/inventory/plex.md), [`jenkins`](../docs/inventory/jenkins.md), [`truenas`](../docs/inventory/truenas.md), [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`ad`](../docs/inventory/ad.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`synology`](../docs/inventory/synology.md), [`ombi`](../docs/inventory/ombi.md), [`pve`](../docs/inventory/pve.md), [`rproxy`](../docs/inventory/rproxy.md), [`prometheus`](../docs/inventory/prometheus.md), [`services`](../docs/inventory/services.md), [`tautulli`](../docs/inventory/tautulli.md), [`ecube`](../docs/inventory/ecube.md), [`semaphore`](../docs/inventory/semaphore.md), [`redmine`](../docs/inventory/redmine.md), [`plex`](../docs/inventory/plex.md), [`jenkins`](../docs/inventory/jenkins.md), [`truenas`](../docs/inventory/truenas.md), [`grafana`](../docs/inventory/grafana.md), [`ansible`](../docs/inventory/ansible.md), [`ad`](../docs/inventory/ad.md) | linux, node_exporter, python, rproxy_secondary, vms |
