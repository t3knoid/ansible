...
| `ecube-0` | [`ecube`](../docs/inventory/ecube.md) | cname, linux, pgdb, python, removable, vms |
...
| `rproxy-0` | [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`jenkins`](../docs/inventory/jenkins.md), [`ombi`](../docs/inventory/ombi.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`ecube`](../docs/inventory/ecube.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`pve`](../docs/inventory/pve.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md) | certbot, certs, cname, linux, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`jenkins`](../docs/inventory/jenkins.md), [`ombi`](../docs/inventory/ombi.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`ecube`](../docs/inventory/ecube.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`pve`](../docs/inventory/pve.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md) | linux, python, rproxy_primary, vms |
| `rproxy-2` | [`truenas`](../docs/inventory/truenas.md), [`rproxy`](../docs/inventory/rproxy.md), [`semaphore`](../docs/inventory/semaphore.md), [`ad`](../docs/inventory/ad.md), [`jenkins`](../docs/inventory/jenkins.md), [`ombi`](../docs/inventory/ombi.md), [`synology`](../docs/inventory/synology.md), [`ansible`](../docs/inventory/ansible.md), [`ecube`](../docs/inventory/ecube.md), [`grafana`](../docs/inventory/grafana.md), [`redmine`](../docs/inventory/redmine.md), [`prometheus`](../docs/inventory/prometheus.md), [`tautulli`](../docs/inventory/tautulli.md), [`pve`](../docs/inventory/pve.md), [`services`](../docs/inventory/services.md), [`plex`](../docs/inventory/plex.md) | linux, python, rproxy_secondary, vms |
