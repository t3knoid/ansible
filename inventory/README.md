...
| `prometheus-0` | [`minecraft`](../docs/inventory/minecraft.md), [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`tautulli`](../docs/inventory/tautulli.md), [`vpn`](../docs/inventory/vpn.md), [`semaphore`](../docs/inventory/semaphore.md), [`grafana`](../docs/inventory/grafana.md), [`prometheus`](../docs/inventory/prometheus.md), [`redmine`](../docs/inventory/redmine.md), [`pg`](../docs/inventory/pg.md) | alertmanager, autofs, blackbox_exporter, cname, linux, prometheus, python, vms |
...
| `rproxy-0` | [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md) | certbot, certs, cname, linux, node_exporter, oauth2_proxy, python, redis, rproxy_main, vms |
| `rproxy-1` | [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md) | linux, node_exporter, python, rproxy_primary, vms |
| `rproxy-2` | [`plex`](../docs/inventory/plex.md), [`services`](../docs/inventory/services.md), [`rproxy`](../docs/inventory/rproxy.md), [`truenas`](../docs/inventory/truenas.md), [`tautulli`](../docs/inventory/tautulli.md), [`ombi`](../docs/inventory/ombi.md), [`ad`](../docs/inventory/ad.md), [`semaphore`](../docs/inventory/semaphore.md), [`jenkins`](../docs/inventory/jenkins.md), [`synology`](../docs/inventory/synology.md), [`prometheus`](../docs/inventory/prometheus.md), [`grafana`](../docs/inventory/grafana.md), [`pve`](../docs/inventory/pve.md), [`redmine`](../docs/inventory/redmine.md), [`ecube`](../docs/inventory/ecube.md), [`ansible`](../docs/inventory/ansible.md) | linux, node_exporter, python, rproxy_secondary, vms |
