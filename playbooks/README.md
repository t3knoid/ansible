...
| [`grafana/restore_db.yml`](../docs/playbooks/restore_db.md) | Restore Grafana PostgreSQL database from backup. |
...
| [`minecraft/check_minecraft_version.yml`](../docs/playbooks/check_minecraft_version.md) | Check latest Minecraft Java Edition version on Minecraft hosts |
...
| [`proxmox/deploy_pve_monitoring.yml`](../docs/playbooks/deploy_pve_monitoring.md) | Deploy Node Exporter and the Proxmox VE Exporter on Proxmox hosts for monitoring Usage: ansible-playbook -i inventory/pve/inventory.ini playbooks/proxmox/deploy_pve_monitoring.yml |
...
| [`semaphoreui/restore_db.yml`](../docs/playbooks/restore_db.md) | Restore Semaphoreui PostgreSQL database from backup. |
...
| [`tautulli/restore_db.yml`](../docs/playbooks/restore_db.md) | Restore Tautulli PostgreSQL database from backup. |
